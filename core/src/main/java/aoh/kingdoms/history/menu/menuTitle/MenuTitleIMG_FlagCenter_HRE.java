...
public class MenuTitleIMG_FlagCenter_HRE extends MenuTitleIMG
{
    ...
    public MenuTitleIMG_FlagCenter_HRE(final int allianceID, final String sText, final String sText2, final boolean moveable, final boolean resizable, final int imageID) {
