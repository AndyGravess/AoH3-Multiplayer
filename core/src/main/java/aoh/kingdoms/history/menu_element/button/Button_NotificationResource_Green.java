...
public class Button_NotificationResource_Green extends Button_Notification_Green
{
    public Button_NotificationResource_Green(final String sText, final String sText2, final int nPosX, final int nPosY, final int nWidth, final int nHeight, final int imageID, final int notificationID, final long lTime) {
