...
public class Button_HRE_Reform_Green extends Button_HRE_Reform
{
    public Button_HRE_Reform_Green(final String sText2, final String sDesc, final int iPosX, final int iPosY, final int nWidth, final int imageID, final int reformID) {
