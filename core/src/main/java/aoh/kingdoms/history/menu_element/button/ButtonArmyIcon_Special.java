...
public class ButtonArmyIcon_Special extends ButtonArmyIcon
{
    protected static long lTimeAnimation;
    protected static int animationState;
    protected static final int ANIMATION_T = 1000;
    
    public ButtonArmyIcon_Special(final int imageID, final int iPosX, final int iPosY) {
        super(imageID, iPosX, iPosY);
    }
    
    public ButtonArmyIcon_Special(final int imageID, final int iPosX, final int iPosY, final boolean isPinned) {
        super(imageID, iPosX, iPosY, isPinned);
    }
    
    public ButtonArmyIcon_Special(final int imageID, final int iPosX, final int iPosY, final boolean isPinned, final String armyKey) {
        super(imageID, iPosX, iPosY, isPinned, armyKey);
    }
    
    public ButtonArmyIcon_Special(final int imageID, final int iPosX, final int iPosY, final boolean isPinned, final String armyKey, final int buttonH) {
        super(imageID, iPosX, iPosY, isPinned, armyKey, buttonH);
    }
    ...
    protected void drawButtonBG(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive) {
        ...
        if (this.getClickable() && this.getIsHovered() && ButtonArmyIcon_Special.animationState >= 0) {
            if (ButtonArmyIcon_Special.animationState == 0) {
                final float drawPerc = Math.min(1.0f * (CFG.currentTimeMillis - ButtonArmyIcon_Special.lTimeAnimation) / 1000.0f, 1.0f);
                ...
                if (ButtonArmyIcon_Special.lTimeAnimation < CFG.currentTimeMillis - 1000L) {
                    ++ButtonArmyIcon_Special.animationState;
                    ButtonArmyIcon_Special.lTimeAnimation = CFG.currentTimeMillis;
                }
            }
            else {
                final float drawPerc = Math.min(1.0f * (CFG.currentTimeMillis - ButtonArmyIcon_Special.lTimeAnimation) / 1000.0f, 1.0f);
                ...
                if (ButtonArmyIcon_Special.lTimeAnimation < CFG.currentTimeMillis - 1000L) {
                    ButtonArmyIcon_Special.animationState = 0;
                    ButtonArmyIcon_Special.lTimeAnimation = CFG.currentTimeMillis;
                }
            }
            oSB.setColor(Color.WHITE);
    ...
    static {
        ButtonArmyIcon_Special.lTimeAnimation = 0L;
        ButtonArmyIcon_Special.animationState = 0;
    }
}
