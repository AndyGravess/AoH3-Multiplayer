...
public class Text_StaticBG_BuildingSlots extends Text_StaticBG
{
    public int id;
    public int lastValue;
    
    public Text_StaticBG_BuildingSlots(final String sText, final int fontID, final int iTextPositionX, final int iPosX, final int iPosY, final int iWidth, final int iHeight, final int id) {
    ...
    public String getTextToDraw() {
        if (this.lastValue != Game.getProvince(this.id).getUsedBuildingsSlots()) {
            this.setText("" + Game.getProvince(this.id).getUsedBuildingsSlots() + " / " + Game.getProvince(this.id).iBuildingsLimit);
            this.lastValue = Game.getProvince(this.id).getUsedBuildingsSlots();
        }
        return this.sText;
    }
