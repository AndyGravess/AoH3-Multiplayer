...
public class MenuElement_HoverElement_Type_ImageTitle implements MenuElement_HoverElement_Type
{
    ...
    public MenuElement_HoverElement_Type_ImageTitle(final int iImageID) {
        this.init(iImageID, 0, CFG.PADDING);
    }
    
    public MenuElement_HoverElement_Type_ImageTitle(final int iImageID, final int offsetLeft) {
        this.init(iImageID, offsetLeft, CFG.PADDING);
    }
    
    public MenuElement_HoverElement_Type_ImageTitle(final int iImageID, final int offsetLeft, final int offsetRight) {
    ...
    public void draw(final SpriteBatch oSB, final int nPosX, final int nPosY, final float nAlpha, final int iMaxWidth) {
        ...
        ImageManager.getImage(this.iImageID).draw(oSB, nPosX + this.offsetLeft, nPosY + CFG.PADDING * 2 + (CFG.TEXT_HEIGHT - this.iHeight) / 2, this.iWidth, this.iHeight);
    }
