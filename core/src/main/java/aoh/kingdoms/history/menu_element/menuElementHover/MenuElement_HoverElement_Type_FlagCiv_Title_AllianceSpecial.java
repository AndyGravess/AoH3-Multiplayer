...
public class MenuElement_HoverElement_Type_FlagCiv_Title_AllianceSpecial implements MenuElement_HoverElement_Type
{
    ...
    public MenuElement_HoverElement_Type_FlagCiv_Title_AllianceSpecial(final int iAllianceID, final String nText2) {
        this.iTextWidthMAX = 0;
        this.iAllianceID = iAllianceID;
        this.sText2 = nText2;
        this.sTextName = Game.lang.get(Game.alliancesSpecial.get(iAllianceID).Name_Alliance);
        Renderer.glyphLayout.setText(Renderer.fontMain.get(MenuElement_HoverElement_Type_FlagCiv_Title_AllianceSpecial.fontID), this.sTextName);
        this.iTextWidthMAX = (int)Renderer.glyphLayout.width;
        Renderer.glyphLayout.setText(Renderer.fontMain.get(MenuElement_HoverElement_Type_FlagCiv_Title_AllianceSpecial.fontID2), this.sText2);
    ...
    public void draw(final SpriteBatch oSB, final int nPosX, final int nPosY, final float nAlpha, final int iMaxWidth) {
        oSB.setColor(Game.getCiv(Game.alliancesSpecial.get(this.iAllianceID).iLeaderCivID).getRGB(0.65f * nAlpha));
