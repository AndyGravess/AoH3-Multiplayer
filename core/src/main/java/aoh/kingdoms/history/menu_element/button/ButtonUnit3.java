...
public class ButtonUnit3 extends MenuElement
{
    ...
    public ButtonUnit3(final int unitTypeID, final int armyID, final int iPosX, final int iPosY, int nWidth, final boolean isClickable, final boolean isResearched) {
        this.iTextWidth = 0;
        this.iTextHeight = 0;
        this.maxIconWidth = 0;
        ...
        ButtonUnit3.iconScale = this.getImageScale(Images.attack);
        ButtonUnit3.attackIconWidth = (int)(ImageManager.getImage(Images.attack).getWidth() * ButtonUnit3.iconScale);
        ButtonUnit3.attackIconHeight = (int)(ImageManager.getImage(Images.attack).getHeight() * ButtonUnit3.iconScale);
        ButtonUnit3.defenseIconWidth = (int)(ImageManager.getImage(Images.defense).getWidth() * ButtonUnit3.iconScale);
        ButtonUnit3.defenseIconHeight = (int)(ImageManager.getImage(Images.defense).getHeight() * ButtonUnit3.iconScale);
        ButtonUnit3.timeIconWidth = (int)(ImageManager.getImage(Images.time).getWidth() * ButtonUnit3.iconScale);
        ButtonUnit3.timeIconHeight = (int)(ImageManager.getImage(Images.time).getHeight() * ButtonUnit3.iconScale);
        ButtonUnit3.goldIconWidth = (int)(ImageManager.getImage(Images.gold).getWidth() * ButtonUnit3.iconScale);
        ButtonUnit3.goldIconHeight = (int)(ImageManager.getImage(Images.gold).getHeight() * ButtonUnit3.iconScale);
        ButtonUnit3.speedIconWidth = (int)(ImageManager.getImage(Images.movementSpeed).getWidth() * ButtonUnit3.iconScale);
        ButtonUnit3.speedIconHeight = (int)(ImageManager.getImage(Images.movementSpeed).getHeight() * ButtonUnit3.iconScale);
        this.maxIconWidth = Math.max(ButtonUnit3.timeIconWidth, Math.max(ButtonUnit3.goldIconWidth, ButtonUnit3.speedIconWidth));
        ButtonUnit3.iconAttackDefenseMaxWidth = Math.max(ButtonUnit3.attackIconWidth, ButtonUnit3.defenseIconWidth);
    ...
    protected void drawButtonBG(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive) {
        ...
        oSB.setColor(new Color(ButtonUnit3.COLOR_STATS.r, ButtonUnit3.COLOR_STATS.g, ButtonUnit3.COLOR_STATS.b, 0.4f));
        ImageManager.getImage(Images.gradientHorizontal).draw(oSB, this.getPosX() + this.getInnerPosX() + iTranslateX, iY, this.getInnerWidth(), iH);
    ...
    protected void drawText(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive) {
        ...
        ImageManager.getImage(Images.gold).draw(oSB, this.getPosX() + this.getWidth() - CFG.PADDING * 2 - ButtonUnit3.goldIconWidth + iTranslateX, this.getPosY() + timeY - ButtonUnit3.goldIconHeight / 2 + iTranslateY, ButtonUnit3.goldIconWidth, ButtonUnit3.goldIconHeight);
        ImageManager.getImage(Images.time).draw(oSB, this.getPosX() + this.getWidth() - CFG.PADDING * 5 - ButtonUnit3.timeIconWidth - ButtonUnit3.goldIconWidth - this.iCostWidth + iTranslateX, this.getPosY() + timeY - ButtonUnit3.timeIconHeight / 2 + iTranslateY, ButtonUnit3.timeIconWidth, ButtonUnit3.timeIconHeight);
        Renderer.drawText(oSB, CFG.FONT_REGULAR_SMALL, this.sCost, this.getPosX() + this.getWidth() - CFG.PADDING * 3 - ButtonUnit3.goldIconWidth - this.iCostWidth + iTranslateX, this.getPosY() + timeY - this.iCostHeight / 2 + iTranslateY, Colors.HOVER_RIGHT2);
        Renderer.drawText(oSB, CFG.FONT_REGULAR_SMALL, this.sRecruitmentTime, this.getPosX() + this.getWidth() - CFG.PADDING * 6 - ButtonUnit3.timeIconWidth - ButtonUnit3.goldIconWidth - this.iCostWidth - this.iRecruitmentTimeWidth + iTranslateX, this.getPosY() + timeY - this.iRecruitmentTimeHeight / 2 + iTranslateY, Colors.HOVER_RIGHT2);
        ImageManager.getImage(Images.movementSpeed).draw(oSB, this.getPosX() + this.getInnerPosX() + CFG.PADDING * 8 + ButtonUnit3.iconAttackDefenseMaxWidth + this.iAttackWidth + (ButtonUnit3.iconAttackDefenseMaxWidth - ButtonUnit3.defenseIconWidth) / 2 + ButtonUnit3.iconAttackDefenseMaxWidth + this.iDefenseWidth + (ButtonUnit3.iconAttackDefenseMaxWidth - ButtonUnit3.speedIconWidth) / 2 + iTranslateX, this.getPosY() + centerY - ButtonUnit3.speedIconHeight / 2 + iTranslateY, ButtonUnit3.speedIconWidth, ButtonUnit3.speedIconHeight);
        Renderer.drawText(oSB, CFG.FONT_REGULAR, this.sSpeed, this.getPosX() + this.getInnerPosX() + CFG.PADDING * 10 + ButtonUnit3.iconAttackDefenseMaxWidth + this.iAttackWidth + (ButtonUnit3.iconAttackDefenseMaxWidth - ButtonUnit3.defenseIconWidth) / 2 + ButtonUnit3.iconAttackDefenseMaxWidth + this.iDefenseWidth + (ButtonUnit3.iconAttackDefenseMaxWidth - ButtonUnit3.speedIconWidth) / 2 + ButtonUnit3.speedIconWidth + iTranslateX, this.getPosY() + centerY - CFG.TEXT_HEIGHT / 2 + iTranslateY, Colors.HOVER_LEFT2);
        ImageManager.getImage(Images.attack).draw(oSB, this.getPosX() + this.getInnerPosX() + CFG.PADDING * 2 + (ButtonUnit3.iconAttackDefenseMaxWidth - ButtonUnit3.attackIconWidth) / 2 + iTranslateX, this.getPosY() + centerY - ButtonUnit3.attackIconHeight / 2 + iTranslateY, ButtonUnit3.attackIconWidth, ButtonUnit3.attackIconHeight);
        Renderer.drawText(oSB, CFG.FONT_REGULAR, this.sAttack, this.getPosX() + this.getInnerPosX() + CFG.PADDING * 4 + ButtonUnit3.iconAttackDefenseMaxWidth + iTranslateX, this.getPosY() + centerY - CFG.TEXT_HEIGHT / 2 + iTranslateY, Colors.HOVER_LEFT2);
        ImageManager.getImage(Images.defense).draw(oSB, this.getPosX() + this.getInnerPosX() + CFG.PADDING * 5 + ButtonUnit3.iconAttackDefenseMaxWidth + this.iAttackWidth + (ButtonUnit3.iconAttackDefenseMaxWidth - ButtonUnit3.defenseIconWidth) / 2 + iTranslateX, this.getPosY() + centerY - ButtonUnit3.attackIconHeight / 2 + iTranslateY, ButtonUnit3.defenseIconWidth, ButtonUnit3.defenseIconHeight);
        Renderer.drawText(oSB, CFG.FONT_REGULAR, this.sDefense, this.getPosX() + this.getInnerPosX() + CFG.PADDING * 7 + ButtonUnit3.iconAttackDefenseMaxWidth * 2 + this.iAttackWidth + iTranslateX, this.getPosY() + centerY - CFG.TEXT_HEIGHT / 2 + iTranslateY, Colors.HOVER_LEFT2);
    }
    ...
    static {
        ButtonUnit3.iconScale = 1.0f;
        ButtonUnit3.iconAttackDefenseMaxWidth = 0;
