...
public class Text_TitleBlue2 extends Text_Static
{
    public Text_TitleBlue2(final String sText, final int iTextPositionX, final int iPosX, final int iPosY, final int iWidth, final int iHeight) {
    ...
    public void draw(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive, final boolean scrollableY) {
        ...
        oSB.setColor(new Color(Colors.HOVER_GOLD.r, Colors.HOVER_GOLD.g, Colors.HOVER_GOLD.b, 0.35f));
        ImageManager.getImage(Images.gradientHorizontal).draw(oSB, this.getPosX() + this.getTextWidth() + CFG.PADDING * 4 + iTranslateX, this.getPosY() + this.getHeight() / 2 + iTranslateY, this.getWidth() - this.getTextWidth() - CFG.PADDING * 6, 1);
        oSB.setColor(Color.WHITE);
        Renderer.drawTextWithShadow(oSB, this.fontID, this.sText, this.getPosX() + CFG.PADDING * 2 + iTranslateX, this.getPosY() + (this.getHeight() - this.getTextHeight()) / 2 + iTranslateY, this.getColor(isActive));
    }
