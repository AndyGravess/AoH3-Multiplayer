...
public class Text_StaticBG_ID_Special extends Text_StaticBG_ID
{
    public Text_StaticBG_ID_Special(final String sText, final int fontID, final int iTextPositionX, final int iPosX, final int iPosY, final int iWidth, final int iHeight, final int id) {
