...
public class TextIcon2_ProvinceIncome extends Button
{
    public int imageID;
    public int iProvinceID;
    public float lastValue;
    
    public TextIcon2_ProvinceIncome(final int nProvinceID, final String sText, final int imageID, final int nPosX, final int nPosY, final int nWidth, final int nHeight) {
