...
public class TextIcon2_Value extends Button
{
    public int imageID;
    public int id;
    
    public TextIcon2_Value(final String sText, final int imageID, final int nPosX, final int nPosY, final int nWidth, final int nHeight, final int id) {
        this.init(sText, CFG.FONT_BOLD_SMALL, 0, nPosX, nPosY, nWidth, nHeight, true, true, false, false);
        this.imageID = imageID;
        this.id = id;
    }
    
    public TextIcon2_Value(final String sText, final int fontID, final int imageID, final int nPosX, final int nPosY, final int nWidth, final int nHeight, final int id) {
