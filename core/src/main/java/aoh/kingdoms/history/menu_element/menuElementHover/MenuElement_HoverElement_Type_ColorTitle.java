...
public class MenuElement_HoverElement_Type_ColorTitle implements MenuElement_HoverElement_Type
{
    ...
    public MenuElement_HoverElement_Type_ColorTitle(final Color oColor) {
        this.offsetLeft = 0;
        this.offsetRight = 0;
        this.init(oColor, this.iHeight = 0, 0, (int)(CFG.TEXT_HEIGHT * 0.9f));
    }
    
    public MenuElement_HoverElement_Type_ColorTitle(final Color oColor, final int offsetLeft) {
        this.offsetLeft = 0;
        this.offsetRight = 0;
        this.iHeight = 0;
    ...
    public MenuElement_HoverElement_Type_ColorTitle(final Color oColor, final int offsetLeft, final int offsetRight) {
        this.offsetLeft = 0;
        this.offsetRight = 0;
        this.iHeight = 0;
    ...
    public MenuElement_HoverElement_Type_ColorTitle(final Color oColor, final int offsetLeft, final int offsetRight, final int nColorHeight) {
        this.offsetLeft = 0;
        this.offsetRight = 0;
        this.iHeight = 0;
    ...
    public void draw(final SpriteBatch oSB, final int nPosX, final int nPosY, final float nAlpha, final int iMaxWidth) {
        ...
        Images.pix.draw(oSB, nPosX + this.offsetLeft, nPosY + CFG.PADDING * 2, CFG.COLOR_WIDTH, CFG.TEXT_HEIGHT);
