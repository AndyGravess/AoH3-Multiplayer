...
public class Text_Title_v2Center extends Text_Static
{
    public Text_Title_v2Center(final String sText, final int iTextPositionX, final int iPosX, final int iPosY, final int iWidth, final int iHeight) {
    ...
    public Text_Title_v2Center(final String sText, final int iTextPositionX, final int fontID, final int iPosX, final int iPosY, final int iWidth, final int iHeight) {
        this.typeOfElement = MenuElement_Type.TEXT;
        this.fontID = fontID;
        this.iTextPositionX = iTextPositionX;
        this.setPosX(iPosX);
