...
public class Button_Notification_Flag_Red extends Button_Notification_Flag
{
    public Button_Notification_Flag_Red(final String sText, final String sText2, final int nPosX, final int nPosY, final int nWidth, final int nHeight, final int imageID, final int notificationID, final long lTime, final int civID) {
