...
public class Button_NotificationResource_Red extends Button_Notification_Red
{
    public Button_NotificationResource_Red(final String sText, final String sText2, final int nPosX, final int nPosY, final int nWidth, final int nHeight, final int imageID, final int notificationID, final long lTime) {
