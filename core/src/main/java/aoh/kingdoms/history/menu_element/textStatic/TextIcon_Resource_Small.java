...
public class TextIcon_Resource_Small extends Button
{
    ...
    public TextIcon_Resource_Small(final int iProvinceID, final String sText, final int resourceID, final int nPosX, final int nPosY, int nWidth, final int nHeight) {
        this.init(sText, CFG.FONT_REGULAR_SMALL, 0, nPosX, nPosY, nWidth, nHeight, true, true, false, false);
        this.resourceID = resourceID;
        this.iProvinceID = iProvinceID;
        if (resourceID >= 0) {
            final float iconScale = Math.min(1.0f, ImageManager.getImage(Images.gold).getHeight() / (float)ResourcesManager.resourceImages.get(resourceID).getHeight());
            ...
            final float iconScale = Math.min(1.0f, ImageManager.getImage(Images.gold).getHeight() / (float)ImageManager.getImage(Images.resourceNone).getHeight());
        ...
        nWidth = this.getWidth() - CFG.PADDING / 2;
        int tWMax = 0;
        try {
