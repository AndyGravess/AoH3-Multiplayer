...
public class ButtonFlag_Animation extends Button
{
    ...
    public ButtonFlag_Animation(final int iPosX, final int iPosY, final boolean isClickable) {
        this.flagImgID = 0;
        this.currentTime = 0L;
        this.ANIMATION_TIME = 125;
    ...
    public ButtonFlag_Animation(final int iCivID, final int iPosX, final int iPosY, final boolean isClickable) {
        this.flagImgID = 0;
        this.currentTime = 0L;
        this.ANIMATION_TIME = 125;
        this.init("", this.fontID, this.iTextPositionX, iPosX, iPosY, getButtonWidth(), getButtonHeight(), isClickable, true, false, false);
    ...
    protected void drawButtonBG(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive) {
        if (this.inAnimation) {
            ...
            Renderer.clipView_Start(oSB, iTranslateX, CFG.GAME_HEIGHT - (this.getPosY() + iTranslateY), CFG.GAME_WIDTH, -(int)(ImageManager.getImage(Images.flagOver.get(this.flagImgID)).getHeight() * (0.2f + 0.8f * ((CFG.currentTimeMillis - this.currentTime) / (float)this.ANIMATION_TIME))));
    ...
    static {
        ButtonFlag_Animation.EXTRA_RANDOM = 0;
    }
}
