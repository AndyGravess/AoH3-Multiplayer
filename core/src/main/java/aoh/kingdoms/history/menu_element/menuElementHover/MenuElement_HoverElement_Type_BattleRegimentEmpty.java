...
public class MenuElement_HoverElement_Type_BattleRegimentEmpty implements MenuElement_HoverElement_Type
{
    public int iCivID;
    public int iImageID;
    ...
    public MenuElement_HoverElement_Type_BattleRegimentEmpty(final int iCivID, final int iImageID) {
        this.init(iCivID, iImageID, 0, CFG.PADDING / 2);
    }
    
    public MenuElement_HoverElement_Type_BattleRegimentEmpty(final int iCivID, final int iImageID, final int offsetLeft) {
        this.init(iCivID, iImageID, offsetLeft, CFG.PADDING / 2);
    }
    
    public MenuElement_HoverElement_Type_BattleRegimentEmpty(final int iCivID, final int iImageID, final int offsetLeft, final int offsetRight) {
    ...
    public void draw(final SpriteBatch oSB, final int nPosX, final int nPosY, final float nAlpha, final int iMaxWidth) {
        oSB.setColor(new Color(Game.getCiv(this.iCivID).getR(), Game.getCiv(this.iCivID).getG(), Game.getCiv(this.iCivID).getB(), 0.225f * nAlpha));
        ...
        oSB.setColor(new Color(1.0f, 1.0f, 1.0f, 0.4f * nAlpha));
