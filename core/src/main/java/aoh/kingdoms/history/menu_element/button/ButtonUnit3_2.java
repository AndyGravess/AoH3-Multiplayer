...
public class ButtonUnit3_2 extends MenuElement
{
    ...
    public ButtonUnit3_2(final int unitTypeID, final int armyID, final int iPosX, final int iPosY, int nWidth, final boolean isClickable, final boolean isResearched) {
        this.iTextWidth = 0;
        this.iTextHeight = 0;
        this.maxIconWidth = 0;
        this.statW = 0;
        ...
        ButtonUnit3_2.iconScale = this.getImageScale(Images.attack);
        ButtonUnit3_2.timeIconWidth = (int)(ImageManager.getImage(Images.time).getWidth() * ButtonUnit3_2.iconScale);
        ButtonUnit3_2.timeIconHeight = (int)(ImageManager.getImage(Images.time).getHeight() * ButtonUnit3_2.iconScale);
        ButtonUnit3_2.goldIconWidth = (int)(ImageManager.getImage(Images.gold).getWidth() * ButtonUnit3_2.iconScale);
        ButtonUnit3_2.goldIconHeight = (int)(ImageManager.getImage(Images.gold).getHeight() * ButtonUnit3_2.iconScale);
        final float iconScale2 = Math.min(0.9f, this.getImageScale2(Images.attack));
        ButtonUnit3_2.speedIconWidth = (int)(ImageManager.getImage(Images.movementSpeed).getWidth() * iconScale2);
        ButtonUnit3_2.speedIconHeight = (int)(ImageManager.getImage(Images.movementSpeed).getHeight() * iconScale2);
        ButtonUnit3_2.attackIconWidth = (int)(ImageManager.getImage(Images.attack).getWidth() * iconScale2);
        ButtonUnit3_2.attackIconHeight = (int)(ImageManager.getImage(Images.attack).getHeight() * iconScale2);
        ButtonUnit3_2.defenseIconWidth = (int)(ImageManager.getImage(Images.defense).getWidth() * iconScale2);
        ButtonUnit3_2.defenseIconHeight = (int)(ImageManager.getImage(Images.defense).getHeight() * iconScale2);
        this.maxIconWidth = Math.max(ButtonUnit3_2.timeIconWidth, Math.max(ButtonUnit3_2.goldIconWidth, ButtonUnit3_2.speedIconWidth));
        ButtonUnit3_2.iconAttackDefenseMaxWidth = Math.max(ButtonUnit3_2.attackIconWidth, ButtonUnit3_2.defenseIconWidth);
    ...
    protected void drawButtonBG(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive) {
        ...
        oSB.setColor(new Color(ButtonUnit3_2.COLOR_STATS.r, ButtonUnit3_2.COLOR_STATS.g, ButtonUnit3_2.COLOR_STATS.b, 0.4f));
        ImageManager.getImage(Images.gradientHorizontal).draw(oSB, this.getPosX() + this.getInnerPosX() + iTranslateX, iY, this.getInnerWidth(), iH);
    ...
    protected void drawText(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive) {
        ...
        ImageManager.getImage(Images.gold).draw(oSB, this.getPosX() + this.getWidth() - CFG.PADDING * 2 - ButtonUnit3_2.goldIconWidth + iTranslateX, this.getPosY() + timeY - ButtonUnit3_2.goldIconHeight / 2 + iTranslateY, ButtonUnit3_2.goldIconWidth, ButtonUnit3_2.goldIconHeight);
        ImageManager.getImage(Images.time).draw(oSB, this.getPosX() + this.getWidth() - CFG.PADDING * 5 - ButtonUnit3_2.timeIconWidth - ButtonUnit3_2.goldIconWidth - this.iCostWidth + iTranslateX, this.getPosY() + timeY - ButtonUnit3_2.timeIconHeight / 2 + iTranslateY, ButtonUnit3_2.timeIconWidth, ButtonUnit3_2.timeIconHeight);
        Renderer.drawText(oSB, CFG.FONT_REGULAR_SMALL, this.sCost, this.getPosX() + this.getWidth() - CFG.PADDING * 3 - ButtonUnit3_2.goldIconWidth - this.iCostWidth + iTranslateX, this.getPosY() + timeY - this.iCostHeight / 2 + iTranslateY, Colors.HOVER_RIGHT2);
        Renderer.drawText(oSB, CFG.FONT_REGULAR_SMALL, this.sRecruitmentTime, this.getPosX() + this.getWidth() - CFG.PADDING * 6 - ButtonUnit3_2.timeIconWidth - ButtonUnit3_2.goldIconWidth - this.iCostWidth - this.iRecruitmentTimeWidth + iTranslateX, this.getPosY() + timeY - this.iRecruitmentTimeHeight / 2 + iTranslateY, Colors.HOVER_RIGHT2);
        ...
        ImageManager.getImage(Images.attack).draw(oSB, this.getPosX() + this.getInnerPosX() + CFG.PADDING + this.statW / 2 - ButtonUnit3_2.attackIconWidth / 2 + iTranslateX, this.getPosY() + this.getTitleHeight() + CFG.PADDING + tHInner - ButtonUnit3_2.attackIconHeight / 2 + iTranslateY, ButtonUnit3_2.attackIconWidth, ButtonUnit3_2.attackIconHeight);
        ...
        ImageManager.getImage(Images.defense).draw(oSB, this.getPosX() + this.getInnerPosX() + CFG.PADDING * 2 + this.statW + this.statW / 2 - ButtonUnit3_2.defenseIconWidth / 2 + iTranslateX, this.getPosY() + this.getTitleHeight() + CFG.PADDING + tHInner - ButtonUnit3_2.defenseIconHeight / 2 + iTranslateY, ButtonUnit3_2.defenseIconWidth, ButtonUnit3_2.defenseIconHeight);
        ...
        ImageManager.getImage(Images.movementSpeed).draw(oSB, this.getPosX() + this.getInnerPosX() + CFG.PADDING * 3 + this.statW * 2 + this.statW / 2 - ButtonUnit3_2.speedIconWidth / 2 + iTranslateX, this.getPosY() + this.getTitleHeight() + CFG.PADDING + tHInner - ButtonUnit3_2.speedIconHeight / 2 + iTranslateY, ButtonUnit3_2.speedIconWidth, ButtonUnit3_2.speedIconHeight);
    ...
    static {
        ButtonUnit3_2.iconScale = 1.0f;
        ButtonUnit3_2.iconAttackDefenseMaxWidth = 0;
