...
public class Text_StaticBG_TitleSpecial_ID extends Text_StaticBG
{
    public int id;
    
    public Text_StaticBG_TitleSpecial_ID(final String sText, final int fontID, final int iTextPositionX, final int iPosX, final int iPosY, final int iWidth, final int iHeight, final int id) {
