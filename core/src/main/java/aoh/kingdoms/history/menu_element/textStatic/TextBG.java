...
public class TextBG extends Button
{
    public TextBG(final String sText, final int textPos, final int iPosX, final int iPosY, final int nHeight) {
    ...
    public TextBG(final String sText, final int textPos, final int iPosX, final int iPosY, final int nWidth, final int nHeight) {
