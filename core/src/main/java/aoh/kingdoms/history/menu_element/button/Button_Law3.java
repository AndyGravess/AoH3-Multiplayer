...
public class Button_Law3 extends Button
{
    public int imageID;
    ...
    public Button_Law3(final String sText2, final String sDesc, final int iPosX, final int iPosY, final int nWidth, final int imageID, final int lawID, final int lawID2) {
    ...
    protected void drawImage(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive) {
        ...
        LawsManager.lawsImages.get(this.imageID).getTexture().bind(1);
    ...
    public void buildElementHover() {
        this.menuElementHover = LawsManager.getHover(this.lawID, this.lawID2);
    }
}
