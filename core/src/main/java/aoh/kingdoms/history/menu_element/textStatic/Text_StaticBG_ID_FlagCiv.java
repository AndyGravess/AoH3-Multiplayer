...
public class Text_StaticBG_ID_FlagCiv extends Text_StaticBG
{
    public int id;
    
    public Text_StaticBG_ID_FlagCiv(final String sText, final int fontID, final int iTextPositionX, final int iPosX, final int iPosY, final int iWidth, final int iHeight, final int id) {
