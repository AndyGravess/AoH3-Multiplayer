...
public class TextIcon2_Population extends Button
{
    public int imageID;
    public int iProvinceID;
    public float lastValue;
    
    public TextIcon2_Population(final int nProvinceID, final String sText, final int imageID, final int nPosX, final int nPosY, final int nWidth, final int nHeight) {
    ...
    public String getTextToDraw() {
        if (this.lastValue != Game.getProvince(this.iProvinceID).getPopulationTotal()) {
            this.setText("" + CFG.getShortNumber(Game.getProvince(this.iProvinceID).getPopulationTotal()));
            this.lastValue = (float)Game.getProvince(this.iProvinceID).getPopulationTotal();
        }
