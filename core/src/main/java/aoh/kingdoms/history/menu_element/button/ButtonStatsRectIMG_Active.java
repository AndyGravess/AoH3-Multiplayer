...
public class ButtonStatsRectIMG_Active extends Button
{
    ...
    public ButtonStatsRectIMG_Active(final String sText, final int imageID, final int iPosX, final int iPosY, final int nWidth, final int nHeight, final int maxIconWidth, final int id) {
    ...
    public ButtonStatsRectIMG_Active(final String sText, final int imageID, final int iPosX, final int iPosY, final int nWidth, final int nHeight, final int maxIconWidth, final int id, final int fontID) {
    ...
    protected void drawButtonBG(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive) {
        ...
        oSB.setColor(Color.WHITE);
        if (this.getClickable() && this.getIsHovered() && ButtonStatsRectIMG_Active.animationState >= 0) {
            if (ButtonStatsRectIMG_Active.animationState == 0) {
                final float drawPerc = Math.min(1.0f * (CFG.currentTimeMillis - ButtonStatsRectIMG_Active.lTimeAnimation) / 1000.0f, 1.0f);
                ...
                if (ButtonStatsRectIMG_Active.lTimeAnimation < CFG.currentTimeMillis - 1000L) {
                    ++ButtonStatsRectIMG_Active.animationState;
                    ButtonStatsRectIMG_Active.lTimeAnimation = CFG.currentTimeMillis;
                }
            }
            else {
                final float drawPerc = Math.min(1.0f * (CFG.currentTimeMillis - ButtonStatsRectIMG_Active.lTimeAnimation) / 1000.0f, 1.0f);
                ...
                if (ButtonStatsRectIMG_Active.lTimeAnimation < CFG.currentTimeMillis - 1000L) {
                    ButtonStatsRectIMG_Active.animationState = 0;
                    ButtonStatsRectIMG_Active.lTimeAnimation = CFG.currentTimeMillis;
                }
            }
            oSB.setColor(Color.WHITE);
    ...
    protected final float getImageScale(final int iImageID) {
    ...
    static {
        ButtonStatsRectIMG_Active.lTimeAnimation = 0L;
        ButtonStatsRectIMG_Active.animationState = 0;
    }
}
