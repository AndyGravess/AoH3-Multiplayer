...
public class MenuElement_HoverElement_Type_Button_TextBonusFlag implements MenuElement_HoverElement_Type
{
    private String sText;
    private int iTextWidth;
    private int iTextHeight;
    private String sText2;
    private int iTextWidth2;
    private int iTextHeight2;
    private Color oColor;
    private Color oColorBonus;
    private int fontID;
    private int fontID2;
    public int imageID;
    ...
    public MenuElement_HoverElement_Type_Button_TextBonusFlag(final String sText, final String sText2, final int imageID, final int fontID, final Color nColorBonus) {
        this.fontID = 0;
        this.fontID2 = 0;
        this.init(sText, sText2, imageID, fontID, CFG.FONT_BOLD_SMALL, Colors.BUTTON_TEXT_BRIGHT, nColorBonus);
    }
    
    public MenuElement_HoverElement_Type_Button_TextBonusFlag(final String sText, final String sText2, final int imageID, final int fontID, final int fontID2, final Color nColorBonus) {
        this.fontID = 0;
        this.fontID2 = 0;
        this.init(sText, sText2, imageID, fontID, fontID2, Colors.BUTTON_TEXT_BRIGHT, nColorBonus);
    }
    
    public MenuElement_HoverElement_Type_Button_TextBonusFlag(final String sText, final String sText2, final int imageID, final int fontID, final int fontID2, final Color nColorLeft, final Color nColorBonus) {
        this.fontID = 0;
        this.fontID2 = 0;
    ...
    public final void init(final String sText, final String sText2, final int imageID, final int nFontID, final int fontID2, final Color oColor, final Color nColorBonus) {
        ...
        final float iconScale = this.getImageScale(Images.flag_rect) * 1.1f;
        this.iconWidth = (int)(ImageManager.getImage(Images.flag_rect).getWidth() * iconScale);
        this.iconHeight = (int)(ImageManager.getImage(Images.flag_rect).getHeight() * iconScale);
    }
    ...
    public void draw(final SpriteBatch oSB, final int nPosX, int nPosY, final float nAlpha, final int iMaxWidth) {
        ...
        Game.getCiv(this.imageID).getFlag().draw(oSB, nPosX + (this.maxIconWidth + CFG.PADDING * 2) / 2 - this.iconWidth / 2, nPosY + (this.getHeight2() - this.iconHeight) / 2, this.iconWidth, this.iconHeight);
        ImageManager.getImage(Images.flag_rect).draw(oSB, nPosX + (this.maxIconWidth + CFG.PADDING * 2) / 2 - this.iconWidth / 2, nPosY + (this.getHeight2() - this.iconHeight) / 2, this.iconWidth, this.iconHeight);
