...
public class Text_StaticBG_Battle extends Text_StaticBG
{
    public Text_StaticBG_Battle(final String sText, final int iTextPositionX, final int iPosX, final int iPosY, final int iWidth, final int iHeight) {
        super(sText, iTextPositionX, iPosX, iPosY, iWidth, iHeight);
    }
    
    public Text_StaticBG_Battle(final String sText, final int fontID, final int iTextPositionX, final int iPosX, final int iPosY, final int iWidth, final int iHeight) {
