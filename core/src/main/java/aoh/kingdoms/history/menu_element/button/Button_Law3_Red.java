...
public class Button_Law3_Red extends Button_Law3
{
    public Button_Law3_Red(final String sText2, final String sDesc, final int iPosX, final int iPosY, final int nWidth, final int imageID, final int lawID, final int lawID2) {
