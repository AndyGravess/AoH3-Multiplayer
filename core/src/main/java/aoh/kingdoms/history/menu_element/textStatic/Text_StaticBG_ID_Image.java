...
public class Text_StaticBG_ID_Image extends Text_StaticBG
{
    public int id;
    public int imageID;
    ...
    public Text_StaticBG_ID_Image(final String sText, final int fontID, final int maxIconWidth, final int iPosX, final int iPosY, final int iWidth, final int iHeight, final int id, final int imageID) {
        super(sText, fontID, 0, iPosX, iPosY, iWidth, iHeight);
        ...
        int tWMax = 0;
        while (this.iTextWidth > this.getWidth() - maxIconWidth && this.getText().length() > 5 && ++tWMax < 100) {
    ...
    public void draw(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive, final boolean scrollableY) {
        ...
        Images.gradientFull.draw(oSB, this.getPosX() + iTranslateX, this.getPosY() + 1 + iTranslateY, this.getWidth(), 1);
        oSB.setColor(Color.WHITE);
        ImageManager.getImage(this.imageID).draw(oSB, this.getPosX() + this.maxIconWidth / 2 - this.iconWidth / 2 + iTranslateX, this.getPosY() + (this.getHeight() - this.iconHeight) / 2 + iTranslateY, this.iconWidth, this.iconHeight);
        Renderer.drawTextWithShadow(oSB, this.fontID, this.getTextToDraw(), this.getPosX() + this.maxIconWidth + iTranslateX, this.getPosY() + (this.getHeight() - CFG.TEXT_HEIGHT) / 2 + iTranslateY, this.getColor(isActive));
    }
