...
public class ButtonStatsBudget_Balance_Spy extends ButtonStatsBudget_Balance
{
    public ButtonStatsBudget_Balance_Spy(final String sText, final String sText2, final int imageID, final int iPosX, final int iPosY, final int nWidth, final int nHeight) {
        super(sText, sText2, imageID, iPosX, iPosY, nWidth, nHeight);
    }
    
    @Override
    protected void drawButtonBG(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive) {
        oSB.setColor(new Color(Colors.COLOR_GRADIENT_BG_BLUE.r, Colors.COLOR_GRADIENT_BG_BLUE.g, Colors.COLOR_GRADIENT_BG_BLUE.b, (this.getIsHovered() || isActive) ? 0.6f : 0.35f));
