...
public class InGameDrawOver_RegroupArmy extends InGameDrawOver
{
    public InGameDrawOver_RegroupArmy() {
        this.fontID = CFG.FONT_BOLD_SMALL;
        this.sText = Game.lang.get("SelectProvincesToWhichYouWantToMoveArmies");
        ...
        InGameDrawOver_RegroupArmy.drawAllTheTime = true;
    }
    
    @Override
    public void draw(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY) {
        if (InGameDrawOver_RegroupArmy.drawAllTheTime) {
