...
public class InGame_SendUltimatum extends Menu
{
    ...
    public InGame_SendUltimatum(final int nCivID) {
        final List<MenuElement> menuElements = new ArrayList<MenuElement>();
        InGame_SendUltimatum.callToWar.clear();
        ...
        InGame_SendUltimatum.iCivID = nCivID;
        ...
        menuElements.add(new ButtonFlag_Diplomacy(InGame_SendUltimatum.iCivID, menuWidth / 2 + maxWidth / 2 + CFG.PADDING * 2, buttonY + tempTitlePaddingY, true));
        menuElements.add(new Text_Static_ID(InGame_SendUltimatum.iCivID, Game.getCiv(InGame_SendUltimatum.iCivID).getCivName(), CFG.FONT_REGULAR, -1, menuWidth / 2 + maxWidth / 2 + CFG.PADDING * 2 + ImageManager.getImage(Images.flagDiplomacyOver).getWidth(), buttonY, tempTextW, tempTitleH));
        ...
        menuElements.add(new ButtonStatsRectIMG_Diplomacy_Flip("" + CFG.getShortNumber(Game.getCiv(InGame_SendUltimatum.iCivID).iRegimentsLimit), Images.regimentsLimit, statsX + CFG.PADDING + statsW, buttonY, statsW, statsH, maxIconW, 0) {
            @Override
            public void buildElementHover() {
                final List<MenuElement_HoverElement> nElements = new ArrayList<MenuElement_HoverElement>();
                final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
                nData.add(new MenuElement_HoverElement_Type_TextTitle(Game.lang.get("RegimentsLimit") + ": ", CFG.FONT_BOLD));
                nData.add(new MenuElement_HoverElement_Type_TextTitle("" + CFG.getShortNumber(Game.getCiv(InGame_SendUltimatum.iCivID).iRegimentsLimit), CFG.FONT_BOLD, Colors.HOVER_GOLD));
                nData.add(new MenuElement_HoverElement_Type_ImageTitle(Images.regimentsLimit, CFG.PADDING, 0));
                nElements.add(new MenuElement_HoverElement(nData));
                nData.clear();
                this.menuElementHover = new MenuElement_Hover(nElements);
        ...
        menuElements.add(new ButtonStatsRectIMG_Diplomacy_Flip("" + Game.getCiv(InGame_SendUltimatum.iCivID).getResearchedTechnologies(), Game_Calendar.IMG_TECHNOLOGY, statsX + CFG.PADDING + statsW, buttonY + CFG.PADDING + statsH, statsW, statsH, maxIconW, 0) {
            @Override
            public void buildElementHover() {
                final List<MenuElement_HoverElement> nElements = new ArrayList<MenuElement_HoverElement>();
                final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
                nData.add(new MenuElement_HoverElement_Type_TextTitle(Game.lang.get("UnlockedTechnologies") + ": ", CFG.FONT_BOLD));
                nData.add(new MenuElement_HoverElement_Type_TextTitle("" + Game.getCiv(InGame_SendUltimatum.iCivID).getResearchedTechnologies(), CFG.FONT_BOLD, Colors.HOVER_GOLD));
                nData.add(new MenuElement_HoverElement_Type_ImageTitle(Game_Calendar.IMG_TECHNOLOGY, CFG.PADDING, 0));
                nElements.add(new MenuElement_HoverElement(nData));
                nData.clear();
                this.menuElementHover = new MenuElement_Hover(nElements);
        ...
        menuElements.add(new ButtonStatsRectIMG_Diplomacy_Flip("" + Game.getCiv(InGame_SendUltimatum.iCivID).getNumOfProvinces(), Images.provinces, statsX + CFG.PADDING + statsW, buttonY + (CFG.PADDING + statsH) * 2, statsW, statsH, maxIconW, 0) {
            @Override
            public void buildElementHover() {
                final List<MenuElement_HoverElement> nElements = new ArrayList<MenuElement_HoverElement>();
                final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
                nData.add(new MenuElement_HoverElement_Type_TextTitle(Game.lang.get("Provinces") + ": ", CFG.FONT_BOLD));
                nData.add(new MenuElement_HoverElement_Type_TextTitle("" + Game.getCiv(InGame_SendUltimatum.iCivID).getNumOfProvinces(), CFG.FONT_BOLD, Colors.HOVER_GOLD));
                nData.add(new MenuElement_HoverElement_Type_ImageTitle(Images.provinces, CFG.PADDING, 0));
                nElements.add(new MenuElement_HoverElement(nData));
                nData.clear();
                this.menuElementHover = new MenuElement_Hover(nElements);
        ...
        RulersManager.loadRulerIMG_DiplomacyRight(InGame_SendUltimatum.iCivID);
        menuElements.add(new ButtonRuler_Diplomacy(Game.player.iCivID, buttonX, buttonY));
        menuElements.add(new ButtonRuler_Diplomacy(InGame_SendUltimatum.iCivID, menuWidth - paddingLeft - ButtonRuler_Diplomacy.getButtonWidth(), buttonY) {
            @Override
        ...
        buttonY += menuElements.get(menuElements.size() - 1).getHeight() + CFG.PADDING;
        if (Game.getCiv(InGame_SendUltimatum.iCivID).diplomacy.getRelation(Game.player.iCivID) > GameValues.war.RELATIONS_TO_DECLARE_WAR) {
            menuElements.add(new Text_Desc(Game.lang.get("ToDeclareWarTheRelationsBetweenCivilizationsMustBeBelowX", GameValues.war.RELATIONS_TO_DECLARE_WAR), paddingLeft, buttonY, menuWidth - paddingLeft * 2) {
                ...
                public void buildElementHover() {
                    final List<MenuElement_HoverElement> nElements = new ArrayList<MenuElement_HoverElement>();
                    final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
                    nData.add(new MenuElement_HoverElement_Type_FlagCiv_Title(Game.player.iCivID, Game.getCiv(InGame_SendUltimatum.iCivID).getCivName()));
                    nElements.add(new MenuElement_HoverElement(nData));
                    nData.clear();
                    nData.add(new MenuElement_HoverElement_Type_Button_TextBonus(Game.lang.get("Opinion") + ": ", ((Game.getCiv(InGame_SendUltimatum.iCivID).diplomacy.getRelation(Game.player.iCivID) > 0.0f) ? "+" : "") + CFG.getPrecision2(Game.getCiv(InGame_SendUltimatum.iCivID).diplomacy.getRelation(Game.player.iCivID), 10), Images.relations, CFG.FONT_REGULAR_SMALL, CFG.FONT_BOLD_SMALL, Colors.HOVER_LEFT, Colors.HOVER_GOLD));
                    nElements.add(new MenuElement_HoverElement(nData));
                    nData.clear();
                ...
                public void actionElement() {
                    if (Game.getCiv(InGame_SendUltimatum.iCivID).getCapitalProvinceID() >= 0) {
                        Game.setActiveProvinceID(Game.getCiv(InGame_SendUltimatum.iCivID).getCapitalProvinceID());
        ...
        menuElements.add(new TextBonus(Game.lang.get("Opinion") + ": ", ((Game.getCiv(InGame_SendUltimatum.iCivID).diplomacy.getRelation(Game.player.iCivID) > 0.0f) ? "+" : "") + CFG.getPrecision2(Game.getCiv(InGame_SendUltimatum.iCivID).diplomacy.getRelation(Game.player.iCivID), 10), Images.relations, paddingLeft, buttonY, (menuWidth - paddingLeft * 2 - CFG.PADDING / 2 * 2) / 2, CFG.TEXT_HEIGHT + CFG.PADDING * 5, iconWidth) {
            @Override
            public void buildElementHover() {
                final List<MenuElement_HoverElement> nElements = new ArrayList<MenuElement_HoverElement>();
                final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
                ...
                nElements.add(new MenuElement_HoverElement(nData));
                nData.clear();
                nData.add(new MenuElement_HoverElement_Type_Button_TextBonus(Game.lang.get("Opinion") + ": ", ((Game.getCiv(InGame_SendUltimatum.iCivID).diplomacy.getRelation(Game.player.iCivID) > 0.0f) ? "+" : "") + CFG.getPrecision2(Game.getCiv(InGame_SendUltimatum.iCivID).diplomacy.getRelation(Game.player.iCivID), 10), Images.relations, CFG.FONT_BOLD, CFG.FONT_BOLD, Colors.HOVER_LEFT, DiplomacyManager.getOpinion_Color((int)Game.getCiv(InGame_SendUltimatum.iCivID).diplomacy.getRelation(Game.player.iCivID))));
                nElements.add(new MenuElement_HoverElement(nData));
                nData.clear();
                nData.add(new MenuElement_HoverElement_Type_Line());
                nElements.add(new MenuElement_HoverElement(nData));
            ...
            @Override
            public void actionElement() {
                if (Game.getCiv(InGame_SendUltimatum.iCivID).diplomacy.getRelation(Game.player.iCivID) > GameValues.war.RELATIONS_TO_DECLARE_WAR && Game.getCiv(InGame_SendUltimatum.iCivID).getCapitalProvinceID() >= 0) {
                    Game.setActiveProvinceID(Game.getCiv(InGame_SendUltimatum.iCivID).getCapitalProvinceID());
                    ProvinceBorderManager.action.setProvinceID(Game.iActiveProvince);
                    Game.menuManager.rebuildInGame_Civ();
                }
        ...
        menuElements.add(new ButtonGame(Game.lang.get("Cancel"), CFG.FONT_REGULAR, -1, paddingLeft, buttonY, (menuWidth - paddingLeft * 2 - CFG.PADDING / 2 * 2) / 2, true) {
            ...
            public void actionElement() {
                ...
                ProvinceBorderManager.updateDrawProvinceBorder_SelectCiv_ByCivID(InGame_SendUltimatum.iCivID);
                InGame_Civ.iRebuildToCivID = InGame_SendUltimatum.iCivID;
        ...
        menuElements.add(new ButtonGame_ImageSparks(Game.lang.get("DeclareWar"), CFG.FONT_REGULAR, -1, paddingLeft + CFG.PADDING + (menuWidth - paddingLeft * 2 - CFG.PADDING / 2 * 2) / 2, buttonY, (menuWidth - paddingLeft * 2 - CFG.PADDING / 2 * 2) / 2, true, Images.war) {
            ...
            public void buildElementHover() {
                ...
                if (Game.getCiv(Game.player.iCivID).diplomacy.haveNonAggressionPact(InGame_SendUltimatum.iCivID)) {
                    ...
                    nElements.add(new MenuElement_HoverElement(nData));
                    nData.clear();
                    nData.add(new MenuElement_HoverElement_Type_Button_TextBonus(Game.lang.get("Expires") + ": ", "" + Game_Calendar.getDate_ByTurnID(Game.getCiv(Game.player.iCivID).diplomacy.nonAggressionPact.get(InGame_SendUltimatum.iCivID).iTurnID), Images.time, CFG.FONT_REGULAR_SMALL, CFG.FONT_BOLD_SMALL, Colors.HOVER_LEFT, Colors.HOVER_GOLD));
                    nElements.add(new MenuElement_HoverElement(nData));
                    nData.clear();
                    nData.add(new MenuElement_HoverElement_Type_Line());
                    nElements.add(new MenuElement_HoverElement(nData));
        ...
        buttonY += menuElements.get(menuElements.size() - 1).getHeight() + CFG.PADDING;
        final List<Integer> alliesLeft = DiplomacyManager.declareWar_AlliesAttacker(Game.player.iCivID, InGame_SendUltimatum.iCivID);
        final List<Integer> alliesRight = DiplomacyManager.declareWar_AlliesDefender(InGame_SendUltimatum.iCivID, Game.player.iCivID);
        if (alliesLeft.size() > 0 || alliesRight.size() > 0) {
                    ...
                    public void actionElement() {
                        ...
                        if (alliesLeft.size() > 0) {
                            for (int i = alliesLeft.size() - 1; i >= 0; --i) {
                                if (InGame_SendUltimatum.callToWar.contains(alliesLeft.get(i))) {
                                    for (int a = InGame_SendUltimatum.callToWar.size() - 1; a >= 0; --a) {
                                        if (InGame_SendUltimatum.callToWar.get(a).equals(alliesLeft.get(i))) {
                                            InGame_SendUltimatum.callToWar.remove(a);
                                            break;
                                        }
                                    }
                                }
                                else {
                                    InGame_SendUltimatum.callToWar.add(alliesLeft.get(i));
                                }
                            }
                        }
                    }
            ...
            for (int i = 0; i < alliesLeft.size(); ++i) {
                menuElements.add(new Text_StaticBG_ID_FlagCiv_GreenRed("" + Game.getCiv(alliesLeft.get(i)).getCivName(), CFG.FONT_REGULAR_SMALL, CFG.PADDING * 2, paddingLeft, buttonY, alliesWidth, buttonH, (int)alliesLeft.get(i)) {
                    @Override
                    public void actionElement() {
                        if (InGame_SendUltimatum.callToWar.contains(this.getCurrent())) {
                            for (int i = InGame_SendUltimatum.callToWar.size() - 1; i >= 0; --i) {
                                if (InGame_SendUltimatum.callToWar.get(i) == this.getCurrent()) {
                                    InGame_SendUltimatum.callToWar.remove(i);
                                    break;
                                }
                            }
                        }
                        else {
                            InGame_SendUltimatum.callToWar.add(this.getCurrent());
                        }
                    }
                    
                    @Override
                    public boolean getCheckboxState() {
                        return InGame_SendUltimatum.callToWar.contains(this.getCurrent());
                    }
        ...
        this.initMenu(new MenuTitleIMG(Game.lang.get("DeclareWar"), true, false, Images.title600) {
            @Override
            public long getTime() {
                return InGame_SendUltimatum.lTime;
            }
    ...
    public void draw(final SpriteBatch oSB, int iTranslateX, final int iTranslateY, final boolean menuIsActive, final Status titleStatus) {
        ...
        if (InGame_SendUltimatum.lTime + 60L >= CFG.currentTimeMillis) {
            iTranslateX = iTranslateX - CFG.BUTTON_WIDTH + (int)(CFG.BUTTON_WIDTH * ((CFG.currentTimeMillis - InGame_SendUltimatum.lTime) / 60.0f));
        }
    ...
    public void setVisible(final boolean visible) {
        ...
        InGame_SendUltimatum.lTime = CFG.currentTimeMillis;
    ...
    public static void confirm() {
        if (actionDeclareWar(Game.player.iCivID, InGame_SendUltimatum.iCivID, false, InGame_SendUltimatum.callToWar)) {
    ...
    static {
        InGame_SendUltimatum.lTime = 0L;
        InGame_SendUltimatum.iCivID = 0;
        InGame_SendUltimatum.callToWar = new ArrayList<Integer>();
    }
}
