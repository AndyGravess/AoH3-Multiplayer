...
public class InGame_Civ_CapitalCity extends Menu
{
    ...
    public InGame_Civ_CapitalCity() {
        ...
        int r1W = (int)((menuWidth - Images.boxTitleBORDERWIDTH * 2) * 0.3f);
        int maxLevel = 0;
        buttonX = paddingLeft + CFG.PADDING;
        final List<Integer> tCivs = new ArrayList<Integer>();
        final List<Long> tCivsPopulation = new ArrayList<Long>();
        final PieChart_Data nPieChartData = new PieChart_Data();
        for (int i = 0; i < Game.getCivsSize(); ++i) {
            if (Game.getCiv(i).getNumOfProvinces() > 0) {
                tCivs.add(i);
                tCivsPopulation.add((long)Game.getProvince(Game.getCiv(i).getCapitalProvinceID()).getPopulationTotal());
                nPieChartData.addPieChartValues(new PieChart_Value(i, (float)Game.getProvince(Game.getCiv(i).getCapitalProvinceID()).getPopulationTotal()));
                if (Game.getCiv(i).getCapitalLevel() > maxLevel) {
                    maxLevel = Game.getCiv(i).getCapitalLevel();
                }
            }
        }
        ...
        menuElements.add(new PieChart_WithStatsFlags(buttonX, buttonY + CFG.PADDING, pieDim - CFG.PADDING * 2, pieDim - CFG.PADDING * 2, nPieChartData, null) {
            ...
            public void buildElementHover() {
                ...
                nData.add(new MenuElement_HoverElement_Type_TextTitle_BG_Center(Game.lang.get("Capital") + ": " + Game.lang.get("Population"), Colors.HOVER_GOLD));
        ...
        menuElements.add(new ButtonStatsRectIMG_Bonuses_Style(Game.lang.get("Max") + ": ", "" + maxLevel, Images.capital, buttonX, buttonY, c0W, buttonH, ImageManager.getImage(Images.battleWidth).getWidth()) {
            @Override
            public void actionElement() {
                Game.menuManager.rebuildInGame_Civ();
            }
            ...
            public void buildElementHover() {
                ...
                nElements.add(new MenuElement_HoverElement(nData));
                nData.clear();
                nData.add(new MenuElement_HoverElement_Type_Button_TextBonus(Game.lang.get("MaximumLevelOfCapitalCity") + ": ", this.sText2, Images.capital, CFG.FONT_REGULAR_SMALL, CFG.FONT_BOLD_SMALL, Colors.HOVER_LEFT, Colors.COLOR_POPULATION));
                nElements.add(new MenuElement_HoverElement(nData));
                nData.clear();
                this.menuElementHover = new MenuElement_Hover(nElements);
            }
        ...
        menuElements.add(new Text_TitleBlueSort(InGame_Civ_CapitalCity.iSortID == 0 || InGame_Civ_CapitalCity.iSortID == 1, InGame_Civ_CapitalCity.iSortID == 1, Game.lang.get("Name"), -1, buttonX, buttonY, r0W, CFG.TEXT_HEIGHT + CFG.PADDING * 6, CFG.FONT_BOLD_SMALL) {
            @Override
            ...
            @Override
            public void actionElement() {
                if (InGame_Civ_CapitalCity.iSortID == 0) {
                    InGame_Civ_CapitalCity.iSortID = 1;
                }
                else {
                    InGame_Civ_CapitalCity.iSortID = 0;
                }
                Game.menuManager.rebuildInGame_Civ_CapitalCity();
                InGame_Civ_CapitalCity.lTime = 0L;
            }
        ...
        menuElements.add(new Text_TitleBlueSort(InGame_Civ_CapitalCity.iSortID == 2 || InGame_Civ_CapitalCity.iSortID == 3, InGame_Civ_CapitalCity.iSortID == 3, Game.lang.get("Capital") + ": " + Game.lang.get("Population"), -1, buttonX, buttonY, r1W, CFG.TEXT_HEIGHT + CFG.PADDING * 6, CFG.FONT_BOLD_SMALL) {
            @Override
            public void drawLines(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive, final boolean scrollableY) {
            }
            ...
            @Override
            public void actionElement() {
                if (InGame_Civ_CapitalCity.iSortID == 2) {
                    InGame_Civ_CapitalCity.iSortID = 3;
                }
                else {
                    InGame_Civ_CapitalCity.iSortID = 2;
                }
                Game.menuManager.rebuildInGame_Civ_CapitalCity();
                InGame_Civ_CapitalCity.lTime = 0L;
            }
            ...
            public void buildElementHover() {
                ...
                final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
                nData.add(new MenuElement_HoverElement_Type_TextTitle(Game.lang.get("SortBy") + ": "));
                nData.add(new MenuElement_HoverElement_Type_TextTitle(Game.lang.get("Capital") + ": " + Game.lang.get("Population"), Colors.HOVER_GOLD));
                nElements.add(new MenuElement_HoverElement(nData));
                nData.clear();
                this.menuElementHover = new MenuElement_Hover(nElements);
            }
        ...
        buttonX += menuElements.get(menuElements.size() - 1).getWidth();
        menuElements.add(new Text_TitleBlueSort(InGame_Civ_CapitalCity.iSortID == 4 || InGame_Civ_CapitalCity.iSortID == 5, InGame_Civ_CapitalCity.iSortID == 5, Game.lang.get("CapitalCity") + ": " + Game.lang.get("Level"), -1, buttonX, buttonY, r1W, CFG.TEXT_HEIGHT + CFG.PADDING * 6, CFG.FONT_BOLD_SMALL) {
            @Override
            public void drawLines(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive, final boolean scrollableY) {
            }
            ...
            @Override
            public void actionElement() {
                if (InGame_Civ_CapitalCity.iSortID == 4) {
                    InGame_Civ_CapitalCity.iSortID = 5;
                }
                else {
                    InGame_Civ_CapitalCity.iSortID = 4;
                }
                Game.menuManager.rebuildInGame_Civ_CapitalCity();
                InGame_Civ_CapitalCity.lTime = 0L;
            }
            ...
            public void buildElementHover() {
                ...
                final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
                nData.add(new MenuElement_HoverElement_Type_TextTitle(Game.lang.get("SortBy") + ": "));
                nData.add(new MenuElement_HoverElement_Type_TextTitle(Game.lang.get("CapitalCity") + ": " + Game.lang.get("Level"), Colors.HOVER_GOLD));
                nElements.add(new MenuElement_HoverElement(nData));
                nData.clear();
                this.menuElementHover = new MenuElement_Hover(nElements);
            }
        ...
        r1W = (int)((menuWidth - Images.boxTitleBORDERWIDTH * 2 - CFG.PADDING * 5) * 0.3f);
        while (!tCivs.isEmpty()) {
            int toAddID = 0;
            if (InGame_Civ_CapitalCity.iSortID == 0) {
            ...
            else if (InGame_Civ_CapitalCity.iSortID == 1) {
                for (int o = 1; o < tCivs.size(); ++o) {
            ...
            else if (InGame_Civ_CapitalCity.iSortID == 2) {
                for (int o = 1; o < tCivs.size(); ++o) {
                    if (tCivsPopulation.get(toAddID) < tCivsPopulation.get(o)) {
                        toAddID = o;
                    }
                }
            }
            else if (InGame_Civ_CapitalCity.iSortID == 3) {
                for (int o = 1; o < tCivs.size(); ++o) {
                    if (tCivsPopulation.get(toAddID) > tCivsPopulation.get(o)) {
                        toAddID = o;
                    }
            ...
            else if (InGame_Civ_CapitalCity.iSortID == 4) {
                for (int o = 1; o < tCivs.size(); ++o) {
                    if (Game.getCiv(tCivs.get(toAddID)).getCapitalLevel() < Game.getCiv(tCivs.get(o)).getCapitalLevel()) {
                        toAddID = o;
                    }
                }
            }
            else if (InGame_Civ_CapitalCity.iSortID == 5) {
                for (int o = 1; o < tCivs.size(); ++o) {
                    if (Game.getCiv(tCivs.get(toAddID)).getCapitalLevel() > Game.getCiv(tCivs.get(o)).getCapitalLevel()) {
                        toAddID = o;
                    }
            ...
            menuElements.add(new Text_StaticBG_ID("" + CFG.getNumberWithSpaces("" + tCivsPopulation.get(toAddID)), CFG.FONT_REGULAR_SMALL, -1, buttonX, buttonY, r1W, buttonH, (int)tCivs.get(toAddID)) {
                @Override
                public void buildElementHover() {
                    final List<MenuElement_HoverElement> nElements = new ArrayList<MenuElement_HoverElement>();
                    final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
                    ...
                    nElements.add(new MenuElement_HoverElement(nData));
                    nData.clear();
                    nData.add(new MenuElement_HoverElement_Type_Button_TextBonus(Game.lang.get("Capital") + ", " + Game.lang.get("Population") + ": ", this.getText(), Images.population, CFG.FONT_REGULAR_SMALL, CFG.FONT_BOLD_SMALL, Colors.HOVER_LEFT, Colors.HOVER_GOLD));
                    nElements.add(new MenuElement_HoverElement(nData));
                    nData.clear();
                    this.menuElementHover = new MenuElement_Hover(nElements);
                }
            ...
            buttonX += menuElements.get(menuElements.size() - 1).getWidth() + CFG.PADDING;
            menuElements.add(new Text_StaticBG_ID("" + Game.getCiv(tCivs.get(toAddID)).getCapitalLevel() + " / " + Game.getCapital_MaxLvl(tCivs.get(toAddID)), CFG.FONT_REGULAR_SMALL, -1, buttonX, buttonY, r1W, buttonH, (int)tCivs.get(toAddID)) {
                @Override
                public void buildElementHover() {
                    final List<MenuElement_HoverElement> nElements = new ArrayList<MenuElement_HoverElement>();
                    final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
                    ...
                    nElements.add(new MenuElement_HoverElement(nData));
                    nData.clear();
                    nData.add(new MenuElement_HoverElement_Type_Button_TextBonus(Game.lang.get("CapitalCity") + ": ", Game.lang.get("Level") + ": " + this.getText(), Images.capital, CFG.FONT_REGULAR_SMALL, CFG.FONT_BOLD_SMALL, Colors.HOVER_LEFT, Colors.HOVER_GOLD));
                    nElements.add(new MenuElement_HoverElement(nData));
                    nData.clear();
                    this.menuElementHover = new MenuElement_Hover(nElements);
                }
            ...
            tCivsPopulation.remove(toAddID);
        }
        final int menuHeight = Math.min(buttonY, CFG.GAME_HEIGHT - menuY - CFG.PADDING * 3);
        menuElements.add(new Empty(0, 0, menuWidth, Math.max(buttonY, menuHeight)));
        this.initMenu(new MenuTitleIMG(Game.lang.get("CapitalCity"), false, false, Images.title500) {
            @Override
            public long getTime() {
                return InGame_Civ_CapitalCity.lTime2;
            }
    ...
    public void draw(final SpriteBatch oSB, int iTranslateX, final int iTranslateY, final boolean menuIsActive, final Status titleStatus) {
        if (InGame_Civ_CapitalCity.lTime + 60L >= CFG.currentTimeMillis) {
            iTranslateX = iTranslateX - CFG.BUTTON_WIDTH + (int)(CFG.BUTTON_WIDTH * ((CFG.currentTimeMillis - InGame_Civ_CapitalCity.lTime) / 60.0f));
        }
    ...
    public void setVisible(final boolean visible) {
        ...
        InGame_Civ_CapitalCity.lTime = CFG.currentTimeMillis;
        InGame_Civ_CapitalCity.lTime2 = InGame_Civ_CapitalCity.lTime;
    }
    ...
    static {
        InGame_Civ_CapitalCity.lTime = 0L;
        InGame_Civ_CapitalCity.lTime2 = 0L;
        InGame_Civ_CapitalCity.iSortID = 4;
    }
}
