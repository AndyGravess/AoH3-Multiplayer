...
public class InGame_Civ_AggressiveExpansion extends Menu
{
    ...
    public InGame_Civ_AggressiveExpansion() {
        ...
        menuElements.add(new PieChart_WithStatsFlags(buttonX, buttonY + CFG.PADDING, pieDim - CFG.PADDING * 2, pieDim - CFG.PADDING * 2, nPieChartData, null) {
            ...
            public void buildElementHover() {
                ...
                for (int i = 0; i < this.pieChartData.getPieChartValuesSize() && i < 10; ++i) {
                    nData.add(new MenuElement_HoverElement_Type_Button_TextBonusFlag(Game.getCiv(this.pieChartData.getCivID(i)).getCivName() + ": ", "" + CFG.getPrecision2(this.pieChartData.getPieChartValue(i).getPercentage(), 1), this.pieChartData.getCivID(i), CFG.FONT_REGULAR_SMALL, CFG.FONT_BOLD_SMALL, Colors.HOVER_LEFT, Colors.HOVER_GOLD));
                    nElements.add(new MenuElement_HoverElement(nData));
                    nData.clear();
                }
        ...
        menuElements.add(new Text_TitleBlueSort(InGame_Civ_AggressiveExpansion.iSortID == 0 || InGame_Civ_AggressiveExpansion.iSortID == 1, InGame_Civ_AggressiveExpansion.iSortID == 1, Game.lang.get("Name"), -1, buttonX, buttonY, r0W, CFG.TEXT_HEIGHT + CFG.PADDING * 6, CFG.FONT_BOLD_SMALL) {
            @Override
            ...
            @Override
            public void actionElement() {
                if (InGame_Civ_AggressiveExpansion.iSortID == 0) {
                    InGame_Civ_AggressiveExpansion.iSortID = 1;
                }
                else {
                    InGame_Civ_AggressiveExpansion.iSortID = 0;
                }
                Game.menuManager.rebuildInGame_Civ_AggressiveExpansion();
                InGame_Civ_AggressiveExpansion.lTime = 0L;
            }
        ...
        menuElements.add(new Text_TitleBlueSort(InGame_Civ_AggressiveExpansion.iSortID == 2 || InGame_Civ_AggressiveExpansion.iSortID == 3, InGame_Civ_AggressiveExpansion.iSortID == 3, Game.lang.get("MaximumManpower"), -1, buttonX, buttonY, r0W, CFG.TEXT_HEIGHT + CFG.PADDING * 6, CFG.FONT_BOLD_SMALL) {
            @Override
            public void drawLines(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive, final boolean scrollableY) {
            }
            ...
            @Override
            public void actionElement() {
                if (InGame_Civ_AggressiveExpansion.iSortID == 2) {
                    InGame_Civ_AggressiveExpansion.iSortID = 3;
                }
                else {
                    InGame_Civ_AggressiveExpansion.iSortID = 2;
                }
                Game.menuManager.rebuildInGame_Civ_AggressiveExpansion();
                InGame_Civ_AggressiveExpansion.lTime = 0L;
            }
        ...
        buttonX += menuElements.get(menuElements.size() - 1).getWidth();
        menuElements.add(new Text_TitleBlueSort(InGame_Civ_AggressiveExpansion.iSortID == 4 || InGame_Civ_AggressiveExpansion.iSortID == 5, InGame_Civ_AggressiveExpansion.iSortID == 5, Game.lang.get("WarWeariness"), -1, buttonX, buttonY, r1W, CFG.TEXT_HEIGHT + CFG.PADDING * 6, CFG.FONT_BOLD_SMALL) {
            @Override
            public void drawLines(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive, final boolean scrollableY) {
            }
            ...
            @Override
            public void actionElement() {
                if (InGame_Civ_AggressiveExpansion.iSortID == 4) {
                    InGame_Civ_AggressiveExpansion.iSortID = 5;
                }
                else {
                    InGame_Civ_AggressiveExpansion.iSortID = 4;
                }
                Game.menuManager.rebuildInGame_Civ_AggressiveExpansion();
                InGame_Civ_AggressiveExpansion.lTime = 0L;
            }
            ...
            public void buildElementHover() {
                ...
                final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
                nData.add(new MenuElement_HoverElement_Type_TextTitle(Game.lang.get("SortBy") + ": "));
                nData.add(new MenuElement_HoverElement_Type_TextTitle(Game.lang.get("WarWeariness"), Colors.HOVER_GOLD));
                nElements.add(new MenuElement_HoverElement(nData));
                nData.clear();
                this.menuElementHover = new MenuElement_Hover(nElements);
            }
        ...
        buttonX += menuElements.get(menuElements.size() - 1).getWidth();
        menuElements.add(new Text_TitleBlueSort(InGame_Civ_AggressiveExpansion.iSortID == 6 || InGame_Civ_AggressiveExpansion.iSortID == 7, InGame_Civ_AggressiveExpansion.iSortID == 7, Game.lang.get("AggressiveExpansion"), -1, buttonX, buttonY, r1W, CFG.TEXT_HEIGHT + CFG.PADDING * 6, CFG.FONT_BOLD_SMALL) {
            @Override
            public void drawLines(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive, final boolean scrollableY) {
            }
            ...
            @Override
            public void actionElement() {
                if (InGame_Civ_AggressiveExpansion.iSortID == 6) {
                    InGame_Civ_AggressiveExpansion.iSortID = 7;
                }
                else {
                    InGame_Civ_AggressiveExpansion.iSortID = 6;
                }
                Game.menuManager.rebuildInGame_Civ_AggressiveExpansion();
                InGame_Civ_AggressiveExpansion.lTime = 0L;
            }
            ...
            public void buildElementHover() {
                ...
                final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
                nData.add(new MenuElement_HoverElement_Type_TextTitle(Game.lang.get("SortBy") + ": "));
                nData.add(new MenuElement_HoverElement_Type_TextTitle(Game.lang.get("AggressiveExpansion"), Colors.HOVER_GOLD));
                nElements.add(new MenuElement_HoverElement(nData));
                nData.clear();
                this.menuElementHover = new MenuElement_Hover(nElements);
            }
        ...
        while (!tCivs.isEmpty()) {
            ...
            else if (InGame_Civ_AggressiveExpansion.iSortID == 1) {
                for (int o = 1; o < tCivs.size(); ++o) {
            ...
            else if (InGame_Civ_AggressiveExpansion.iSortID == 2) {
                for (int o = 1; o < tCivs.size(); ++o) {
            ...
            else if (InGame_Civ_AggressiveExpansion.iSortID == 3) {
                for (int o = 1; o < tCivs.size(); ++o) {
                    if (Game.getCiv(tCivs.get(toAddID)).fManpowerMax > Game.getCiv(tCivs.get(o)).fManpowerMax) {
                        toAddID = o;
                    }
            ...
            else if (InGame_Civ_AggressiveExpansion.iSortID == 4) {
                for (int o = 1; o < tCivs.size(); ++o) {
                    if (Game.getCiv(tCivs.get(toAddID)).getWarWeariness() < Game.getCiv(tCivs.get(o)).getWarWeariness()) {
                        toAddID = o;
                    }
                }
            }
            else if (InGame_Civ_AggressiveExpansion.iSortID == 5) {
                for (int o = 1; o < tCivs.size(); ++o) {
                    if (Game.getCiv(tCivs.get(toAddID)).getWarWeariness() > Game.getCiv(tCivs.get(o)).getWarWeariness()) {
                        toAddID = o;
                    }
            ...
            else if (InGame_Civ_AggressiveExpansion.iSortID == 6) {
                for (int o = 1; o < tCivs.size(); ++o) {
                    if (Game.getCiv(tCivs.get(toAddID)).getAggressiveExpansion() < Game.getCiv(tCivs.get(o)).getAggressiveExpansion()) {
                        toAddID = o;
                    }
                }
            }
            else if (InGame_Civ_AggressiveExpansion.iSortID == 7) {
                for (int o = 1; o < tCivs.size(); ++o) {
                    if (Game.getCiv(tCivs.get(toAddID)).getAggressiveExpansion() > Game.getCiv(tCivs.get(o)).getAggressiveExpansion()) {
                        toAddID = o;
                    }
            ...
            menuElements.add(new Text_StaticBG_ID("" + CFG.getNumberWithSpaces("" + (int)Game.getCiv(tCivs.get(toAddID)).fManpowerMax), CFG.FONT_REGULAR_SMALL, -1, buttonX, buttonY, r0W, buttonH, (int)tCivs.get(toAddID)) {
                @Override
                public void buildElementHover() {
                    final List<MenuElement_HoverElement> nElements = new ArrayList<MenuElement_HoverElement>();
                    final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
            ...
            buttonX += menuElements.get(menuElements.size() - 1).getWidth() + CFG.PADDING;
            menuElements.add(new Text_StaticBG_ID("" + CFG.getPrecision2(Game.getCiv(tCivs.get(toAddID)).getWarWeariness(), 10) + "%", CFG.FONT_REGULAR_SMALL, -1, buttonX, buttonY, r1W, buttonH, (int)tCivs.get(toAddID)) {
                @Override
                public void buildElementHover() {
                    final List<MenuElement_HoverElement> nElements = new ArrayList<MenuElement_HoverElement>();
                    final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
                    ...
                    nElements.add(new MenuElement_HoverElement(nData));
                    nData.clear();
                    nData.add(new MenuElement_HoverElement_Type_Button_TextBonus(Game.lang.get("WarWeariness") + ": ", this.getText(), Images.weariness, CFG.FONT_REGULAR_SMALL, CFG.FONT_BOLD_SMALL, Colors.HOVER_LEFT, Colors.HOVER_GOLD));
                    nElements.add(new MenuElement_HoverElement(nData));
                    nData.clear();
                    this.menuElementHover = new MenuElement_Hover(nElements);
                }
            ...
            buttonX += menuElements.get(menuElements.size() - 1).getWidth() + CFG.PADDING;
            menuElements.add(new Text_StaticBG_ID("" + CFG.getPrecision2(Game.getCiv(tCivs.get(toAddID)).getAggressiveExpansion(), 10), CFG.FONT_REGULAR_SMALL, -1, buttonX, buttonY, r1W, buttonH, (int)tCivs.get(toAddID)) {
                @Override
                public void buildElementHover() {
                    final List<MenuElement_HoverElement> nElements = new ArrayList<MenuElement_HoverElement>();
                    final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
                    ...
                    nElements.add(new MenuElement_HoverElement(nData));
                    nData.clear();
                    nData.add(new MenuElement_HoverElement_Type_Button_TextBonus(Game.lang.get("AggressiveExpansion") + ": ", this.getText(), Images.aggressiveExpansion, CFG.FONT_REGULAR_SMALL, CFG.FONT_BOLD_SMALL, Colors.HOVER_LEFT, Colors.HOVER_GOLD));
                    nElements.add(new MenuElement_HoverElement(nData));
                    nData.clear();
                    this.menuElementHover = new MenuElement_Hover(nElements);
                }
        ...
        this.initMenu(new MenuTitleIMG(Game.lang.get("Civilizations"), false, false, Images.title500) {
            @Override
            public long getTime() {
                return InGame_Civ_AggressiveExpansion.lTime2;
            }
    ...
    public void draw(final SpriteBatch oSB, int iTranslateX, final int iTranslateY, final boolean menuIsActive, final Status titleStatus) {
        if (InGame_Civ_AggressiveExpansion.lTime + 60L >= CFG.currentTimeMillis) {
            iTranslateX = iTranslateX - CFG.BUTTON_WIDTH + (int)(CFG.BUTTON_WIDTH * ((CFG.currentTimeMillis - InGame_Civ_AggressiveExpansion.lTime) / 60.0f));
        }
    ...
    public void setVisible(final boolean visible) {
        ...
        InGame_Civ_AggressiveExpansion.lTime = CFG.currentTimeMillis;
        InGame_Civ_AggressiveExpansion.lTime2 = InGame_Civ_AggressiveExpansion.lTime;
    }
    ...
    static {
        InGame_Civ_AggressiveExpansion.lTime = 0L;
        InGame_Civ_AggressiveExpansion.lTime2 = 0L;
        InGame_Civ_AggressiveExpansion.iSortID = 6;
    }
}
