...
public class InGame_BattleArmyDefenders extends Menu
{
    ...
    public InGame_BattleArmyDefenders() {
        ...
        if (InGame_Battle.battleID >= 0) {
            for (int i = 0, iSize = Game.battleManager.getBattle(InGame_Battle.battleID).attackingArmy.firstLine.size(); i < iSize; ++i) {
                if (Game.battleManager.getBattle(InGame_Battle.battleID).attackingArmy.firstLine.get(i) != null) {
                    this.addRegiment(Game.battleManager.getBattle(InGame_Battle.battleID).attackingArmy.firstLine.get(i).aR.uID, Game.battleManager.getBattle(InGame_Battle.battleID).attackingArmy.firstLine.get(i).aR.aID, Game.battleManager.getBattle(InGame_Battle.battleID).attackingArmy.firstLine.get(i).aR.num, Game.battleManager.getBattle(InGame_Battle.battleID).attackingArmy.firstLine.get(i).c);
                }
            }
        ...
        this.initMenu(null, InGame_BattleArmyDefenders.mPosX, InGame_BattleArmyDefenders.mPosY, InGame_BattleArmyDefenders.mWidth, ImageManager.getImage(Images.unitsFrameBattle).getHeight() + ButtonArmyBattle.getStatsHeight() + 1, menuElements, false);
    ...
    static {
        InGame_BattleArmyDefenders.mPosX = 0;
        InGame_BattleArmyDefenders.mPosY = 0;
        InGame_BattleArmyDefenders.mWidth = 0;
    }
