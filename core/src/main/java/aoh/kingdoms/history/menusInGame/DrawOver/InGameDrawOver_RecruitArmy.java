...
public class InGameDrawOver_RecruitArmy extends InGameDrawOver
{
    public InGameDrawOver_RecruitArmy() {
        this.fontID = CFG.FONT_BOLD_SMALL;
        this.sText = Game.lang.get("ChooseAProvince");
        ...
        InGameDrawOver_RecruitArmy.drawAllTheTime = true;
    }
    
    @Override
    public void draw(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY) {
        if (InGameDrawOver_RecruitArmy.drawAllTheTime) {
