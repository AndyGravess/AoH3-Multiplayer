...
public class InGame_Civ_MilitaryAcademy extends Menu
{
    ...
    public InGame_Civ_MilitaryAcademy() {
        ...
        menuElements.add(new ButtonStatsRectIMG_Bonuses_Style(Game.lang.get("Civilizations") + ": ", "" + tCivs.size(), Images.council, buttonX, buttonY, menuWidth - paddingLeft * 2, buttonH, ImageManager.getImage(Images.battleWidth).getWidth()) {
            @Override
        ...
        menuElements.add(new Text_TitleBlueSort(InGame_Civ_MilitaryAcademy.iSortID == 0 || InGame_Civ_MilitaryAcademy.iSortID == 1, InGame_Civ_MilitaryAcademy.iSortID == 1, Game.lang.get("Name"), -1, buttonX, buttonY, r0W, CFG.TEXT_HEIGHT + CFG.PADDING * 6, CFG.FONT_BOLD_SMALL) {
            @Override
            ...
            @Override
            public void actionElement() {
                if (InGame_Civ_MilitaryAcademy.iSortID == 0) {
                    InGame_Civ_MilitaryAcademy.iSortID = 1;
                }
                else {
                    InGame_Civ_MilitaryAcademy.iSortID = 0;
                }
                Game.menuManager.rebuildInGame_Civ_MilitaryAcademy();
                InGame_Civ_MilitaryAcademy.lTime = 0L;
            }
        ...
        menuElements.add(new Text_TitleBlueSort(InGame_Civ_MilitaryAcademy.iSortID == 2 || InGame_Civ_MilitaryAcademy.iSortID == 3, InGame_Civ_MilitaryAcademy.iSortID == 3, Game.lang.get("MilitaryAcademy"), -1, buttonX, buttonY, r1W, CFG.TEXT_HEIGHT + CFG.PADDING * 6, CFG.FONT_BOLD_SMALL) {
            @Override
            public void drawLines(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive, final boolean scrollableY) {
            }
            ...
            @Override
            public void actionElement() {
                if (InGame_Civ_MilitaryAcademy.iSortID == 2) {
                    InGame_Civ_MilitaryAcademy.iSortID = 3;
                }
                else {
                    InGame_Civ_MilitaryAcademy.iSortID = 2;
                }
                Game.menuManager.rebuildInGame_Civ_MilitaryAcademy();
                InGame_Civ_MilitaryAcademy.lTime = 0L;
            }
            ...
            public void buildElementHover() {
                ...
                final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
                nData.add(new MenuElement_HoverElement_Type_TextTitle(Game.lang.get("SortBy") + ": "));
                nData.add(new MenuElement_HoverElement_Type_TextTitle(Game.lang.get("MilitaryAcademy"), Colors.HOVER_GOLD));
                nElements.add(new MenuElement_HoverElement(nData));
                nData.clear();
                this.menuElementHover = new MenuElement_Hover(nElements);
            }
        ...
        buttonX += menuElements.get(menuElements.size() - 1).getWidth();
        menuElements.add(new Text_TitleBlueSort(InGame_Civ_MilitaryAcademy.iSortID == 4 || InGame_Civ_MilitaryAcademy.iSortID == 5, InGame_Civ_MilitaryAcademy.iSortID == 5, Game.lang.get("MilitaryAcademyForGenerals"), -1, buttonX, buttonY, r1W, CFG.TEXT_HEIGHT + CFG.PADDING * 6, CFG.FONT_BOLD_SMALL) {
            @Override
            public void drawLines(final SpriteBatch oSB, final int iTranslateX, final int iTranslateY, final boolean isActive, final boolean scrollableY) {
            }
            ...
            @Override
            public void actionElement() {
                if (InGame_Civ_MilitaryAcademy.iSortID == 4) {
                    InGame_Civ_MilitaryAcademy.iSortID = 5;
                }
                else {
                    InGame_Civ_MilitaryAcademy.iSortID = 4;
                }
                Game.menuManager.rebuildInGame_Civ_MilitaryAcademy();
                InGame_Civ_MilitaryAcademy.lTime = 0L;
            }
            ...
            public void buildElementHover() {
                ...
                final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
                nData.add(new MenuElement_HoverElement_Type_TextTitle(Game.lang.get("SortBy") + ": "));
                nData.add(new MenuElement_HoverElement_Type_TextTitle(Game.lang.get("MilitaryAcademyForGenerals"), Colors.HOVER_GOLD));
                nElements.add(new MenuElement_HoverElement(nData));
                nData.clear();
                this.menuElementHover = new MenuElement_Hover(nElements);
            }
        ...
        while (!tCivs.isEmpty()) {
            ...
            else if (InGame_Civ_MilitaryAcademy.iSortID == 1) {
                for (int o = 1; o < tCivs.size(); ++o) {
            ...
            else if (InGame_Civ_MilitaryAcademy.iSortID == 2) {
                for (int o = 1; o < tCivs.size(); ++o) {
                    if (Game.getCiv(tCivs.get(toAddID)).getMilitaryAcademyLevel() < Game.getCiv(tCivs.get(o)).getMilitaryAcademyLevel()) {
                        toAddID = o;
                    }
                }
            }
            else if (InGame_Civ_MilitaryAcademy.iSortID == 3) {
                for (int o = 1; o < tCivs.size(); ++o) {
                    if (Game.getCiv(tCivs.get(toAddID)).getMilitaryAcademyLevel() > Game.getCiv(tCivs.get(o)).getMilitaryAcademyLevel()) {
                        toAddID = o;
                    }
            ...
            else if (InGame_Civ_MilitaryAcademy.iSortID == 4) {
                for (int o = 1; o < tCivs.size(); ++o) {
                    if (Game.getCiv(tCivs.get(toAddID)).getMilitaryAcademyForGeneralsLevel() < Game.getCiv(tCivs.get(o)).getMilitaryAcademyForGeneralsLevel()) {
                        toAddID = o;
                    }
                }
            }
            else if (InGame_Civ_MilitaryAcademy.iSortID == 5) {
                for (int o = 1; o < tCivs.size(); ++o) {
                    if (Game.getCiv(tCivs.get(toAddID)).getMilitaryAcademyForGeneralsLevel() > Game.getCiv(tCivs.get(o)).getMilitaryAcademyForGeneralsLevel()) {
                        toAddID = o;
                    }
            ...
            menuElements.add(new Text_StaticBG_ID("" + Game.getCiv(tCivs.get(toAddID)).getMilitaryAcademyLevel() + " / " + Game.getMilitaryAcademy_MaxLvl(tCivs.get(toAddID)), CFG.FONT_REGULAR_SMALL, -1, buttonX, buttonY, r1W, buttonH, (int)tCivs.get(toAddID)) {
                @Override
                public void buildElementHover() {
                    final List<MenuElement_HoverElement> nElements = new ArrayList<MenuElement_HoverElement>();
                    final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
                    ...
                    nElements.add(new MenuElement_HoverElement(nData));
                    nData.clear();
                    nData.add(new MenuElement_HoverElement_Type_Button_TextBonus(Game.lang.get("MilitaryAcademy") + ": ", Game.lang.get("Level") + ": " + this.getText(), Game_Calendar.IMG_MANPOWER, CFG.FONT_REGULAR_SMALL, CFG.FONT_BOLD_SMALL, Colors.HOVER_LEFT, Colors.HOVER_GOLD));
                    nElements.add(new MenuElement_HoverElement(nData));
                    nData.clear();
                    this.menuElementHover = new MenuElement_Hover(nElements);
                }
            ...
            buttonX += menuElements.get(menuElements.size() - 1).getWidth() + CFG.PADDING;
            menuElements.add(new Text_StaticBG_ID("" + Game.getCiv(tCivs.get(toAddID)).getMilitaryAcademyForGeneralsLevel() + " / " + Game.getMilitaryAcademyForGenerals_MaxLvl(tCivs.get(toAddID)), CFG.FONT_REGULAR_SMALL, -1, buttonX, buttonY, r1W, buttonH, (int)tCivs.get(toAddID)) {
                @Override
                public void buildElementHover() {
                    final List<MenuElement_HoverElement> nElements = new ArrayList<MenuElement_HoverElement>();
                    final List<MenuElement_HoverElement_Type> nData = new ArrayList<MenuElement_HoverElement_Type>();
                    ...
                    nElements.add(new MenuElement_HoverElement(nData));
                    nData.clear();
                    nData.add(new MenuElement_HoverElement_Type_Button_TextBonus(Game.lang.get("MilitaryAcademyForGenerals") + ": ", Game.lang.get("Level") + ": " + this.getText(), Images.general, CFG.FONT_REGULAR_SMALL, CFG.FONT_BOLD_SMALL, Colors.HOVER_LEFT, Colors.HOVER_GOLD));
                    nElements.add(new MenuElement_HoverElement(nData));
                    nData.clear();
                    this.menuElementHover = new MenuElement_Hover(nElements);
                }
        ...
        this.initMenu(new MenuTitleIMG_DoubleText(Game.lang.get("MilitaryAcademy"), Game.lang.get("MilitaryAcademyForGenerals"), false, false, Images.title500) {
            @Override
            public long getTime() {
                return InGame_Civ_MilitaryAcademy.lTime2;
            }
    ...
    public void draw(final SpriteBatch oSB, int iTranslateX, final int iTranslateY, final boolean menuIsActive, final Status titleStatus) {
        if (InGame_Civ_MilitaryAcademy.lTime + 60L >= CFG.currentTimeMillis) {
            iTranslateX = iTranslateX - CFG.BUTTON_WIDTH + (int)(CFG.BUTTON_WIDTH * ((CFG.currentTimeMillis - InGame_Civ_MilitaryAcademy.lTime) / 60.0f));
        }
    ...
    public void setVisible(final boolean visible) {
        ...
        InGame_Civ_MilitaryAcademy.lTime = CFG.currentTimeMillis;
        InGame_Civ_MilitaryAcademy.lTime2 = InGame_Civ_MilitaryAcademy.lTime;
    }
    ...
    static {
        InGame_Civ_MilitaryAcademy.lTime = 0L;
        InGame_Civ_MilitaryAcademy.lTime2 = 0L;
        InGame_Civ_MilitaryAcademy.iSortID = 4;
    }
}
