...
public class GameCivsEditReligion extends Menu
{
    public GameCivsEditReligion() {
        ...
        for (int i = 0; i < Game.religionManager.getReligionsSize(); ++i) {
            menuElements.add(new ButtonMain(Game.religionManager.getReligion(i).Name, 1, textPosX, paddingLeft, buttonY, CFG.LEFT_MENU_WIDTH - paddingLeft * 2, true));
    ...
    public void updateLanguage() {
        ...
        this.getTitle().setText(Game.lang.get("Religion"));
    }
    
    @Override
    public void actionElement(final int nMenuElementID) {
        GameCivsEdit.nCiv.ReligionID = nMenuElementID;
