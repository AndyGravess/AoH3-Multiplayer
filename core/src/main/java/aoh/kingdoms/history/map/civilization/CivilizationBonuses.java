...
public class CivilizationBonuses
{
    ...
    public int MaximumLevelOfNuclearReactor;
    ...
    public CivilizationBonuses() {
        this.TempTurnID = 0;
    }
    
    public CivilizationBonuses(final int nTemporary_TurnID) {
        this.TempTurnID = 0;
        this.TempTurnID = nTemporary_TurnID;
    }
}
