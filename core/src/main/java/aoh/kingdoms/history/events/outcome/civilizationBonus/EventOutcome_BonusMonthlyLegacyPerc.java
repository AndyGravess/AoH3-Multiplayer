...
public class EventOutcome_BonusMonthlyLegacyPerc extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusMonthlyLegacyPerc(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.MonthlyLegacy_Percentage = this.value / 100.0f;
