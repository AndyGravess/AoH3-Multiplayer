...
public class EventOutcome_BonusRecruitArmyFirstLineCost extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusRecruitArmyFirstLineCost(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.RecruitArmyFirstLineCost = this.value;
