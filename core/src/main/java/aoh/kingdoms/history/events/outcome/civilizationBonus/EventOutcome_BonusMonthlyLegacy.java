...
public class EventOutcome_BonusMonthlyLegacy extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusMonthlyLegacy(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.MonthlyLegacy = this.value;
