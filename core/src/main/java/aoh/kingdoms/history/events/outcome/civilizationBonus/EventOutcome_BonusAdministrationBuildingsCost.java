...
public class EventOutcome_BonusAdministrationBuildingsCost extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusAdministrationBuildingsCost(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.AdministrationBuildingsCost = this.value / 100.0f;
