...
public class EventOutcome_BonusImproveRelationsModifier extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusImproveRelationsModifier(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.ImproveRelationsModifier = this.value;
