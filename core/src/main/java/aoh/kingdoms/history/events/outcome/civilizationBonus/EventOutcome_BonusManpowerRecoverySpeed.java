...
public class EventOutcome_BonusManpowerRecoverySpeed extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusManpowerRecoverySpeed(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.ManpowerRecoverySpeed = this.value / 100.0f;
    ...
    @Override
    public int getImage() {
        return Game_Calendar.IMG_MANPOWER_TIME;
    }
}
