...
public class EventOutcome_BonusIncreaseTaxEfficiencyCost extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusIncreaseTaxEfficiencyCost(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.IncreaseTaxEfficiencyCost = this.value / 100.0f;
