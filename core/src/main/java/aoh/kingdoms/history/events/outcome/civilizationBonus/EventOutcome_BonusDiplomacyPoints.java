...
public class EventOutcome_BonusDiplomacyPoints extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusDiplomacyPoints(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.DiplomacyPoints = this.value / 100.0f;
