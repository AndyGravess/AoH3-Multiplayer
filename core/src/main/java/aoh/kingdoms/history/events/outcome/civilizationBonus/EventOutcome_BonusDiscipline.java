...
public class EventOutcome_BonusDiscipline extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusDiscipline(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.Discipline = this.value / 100.0f;
