...
public class EventOutcome_BonusGeneralDefense extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusGeneralDefense(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.GeneralDefense = (int)this.value;
