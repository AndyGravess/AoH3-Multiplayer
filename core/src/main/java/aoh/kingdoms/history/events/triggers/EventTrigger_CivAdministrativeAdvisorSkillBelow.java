...
public class EventTrigger_CivAdministrativeAdvisorSkillBelow extends EventTrigger_Value
{
    public int value;
    
    public EventTrigger_CivAdministrativeAdvisorSkillBelow(final int value) {
        this.value = value;
    }
