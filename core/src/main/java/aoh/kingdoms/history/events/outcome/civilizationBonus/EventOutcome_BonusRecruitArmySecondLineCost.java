...
public class EventOutcome_BonusRecruitArmySecondLineCost extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusRecruitArmySecondLineCost(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.RecruitArmySecondLineCost = this.value;
