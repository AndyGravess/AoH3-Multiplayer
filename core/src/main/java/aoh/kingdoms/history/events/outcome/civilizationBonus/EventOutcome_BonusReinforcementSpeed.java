...
public class EventOutcome_BonusReinforcementSpeed extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusReinforcementSpeed(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.ReinforcementSpeed = this.value / 100.0f;
