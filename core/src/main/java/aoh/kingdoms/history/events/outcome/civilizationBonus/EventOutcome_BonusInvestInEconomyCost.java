...
public class EventOutcome_BonusInvestInEconomyCost extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusInvestInEconomyCost(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.InvestInEconomyCost = this.value / 100.0f;
    ...
    @Override
    public int getImage() {
        return Game_Calendar.IMG_ECONOMY_UP;
    }
}
