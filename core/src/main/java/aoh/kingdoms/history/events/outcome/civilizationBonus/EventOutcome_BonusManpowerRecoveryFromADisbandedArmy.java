...
public class EventOutcome_BonusManpowerRecoveryFromADisbandedArmy extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusManpowerRecoveryFromADisbandedArmy(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.ManpowerRecoveryFromADisbandedArmy = this.value / 100.0f;
    ...
    @Override
    public int getImage() {
        return Game_Calendar.IMG_MANPOWER_DISBAND;
    }
}
