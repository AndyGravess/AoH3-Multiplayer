...
public class EventOutcome_BonusMaximumAmountOfGold extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusMaximumAmountOfGold(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.MaximumAmountOfGold = this.value;
