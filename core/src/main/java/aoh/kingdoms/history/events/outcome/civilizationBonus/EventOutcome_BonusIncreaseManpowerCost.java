...
public class EventOutcome_BonusIncreaseManpowerCost extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusIncreaseManpowerCost(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.IncreaseManpowerCost = this.value;
    ...
    @Override
    public int getImage() {
        return Game_Calendar.IMG_MANPOWER_UP;
    }
}
