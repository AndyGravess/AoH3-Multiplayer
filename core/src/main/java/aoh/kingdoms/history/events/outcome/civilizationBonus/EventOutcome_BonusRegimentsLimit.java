...
public class EventOutcome_BonusRegimentsLimit extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusRegimentsLimit(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.RegimentsLimit = (int)this.value;
