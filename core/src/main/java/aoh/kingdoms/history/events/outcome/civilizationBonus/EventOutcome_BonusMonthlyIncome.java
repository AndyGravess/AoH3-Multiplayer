...
public class EventOutcome_BonusMonthlyIncome extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusMonthlyIncome(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.MonthlyIncome = this.value;
