...
public class EventOutcome_BonusIncomeFromVassals extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusIncomeFromVassals(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.IncomeFromVassals = this.value / 100.0f;
