...
public class EventOutcome_BonusLoanInterest extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusLoanInterest(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.LoanInterest = this.value;
