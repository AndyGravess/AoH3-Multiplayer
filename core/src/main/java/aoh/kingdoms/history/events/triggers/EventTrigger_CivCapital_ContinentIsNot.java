...
public class EventTrigger_CivCapital_ContinentIsNot extends EventTrigger_Value
{
    public int value;
    
    public EventTrigger_CivCapital_ContinentIsNot(final int value) {
        this.value = value;
    }
    ...
    public String getText() {
        return Game.lang.get("Capital") + ", " + Game.lang.get("Continent") + " " + Game.lang.get("NOT") + ": ";
    }
