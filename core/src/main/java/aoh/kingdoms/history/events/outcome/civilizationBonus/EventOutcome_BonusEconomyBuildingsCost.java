...
public class EventOutcome_BonusEconomyBuildingsCost extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusEconomyBuildingsCost(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.EconomyBuildingsCost = this.value / 100.0f;
