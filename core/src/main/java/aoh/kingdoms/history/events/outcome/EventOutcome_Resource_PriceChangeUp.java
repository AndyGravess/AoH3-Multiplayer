...
public class EventOutcome_Resource_PriceChangeUp extends EventOutcome
{
    ...
    public EventOutcome_Resource_PriceChangeUp(final int iResourceID, final int changePrice_Min, final int changePrice_Random, final int timeInMonths_Min, final int timeInMonths_Random) {
