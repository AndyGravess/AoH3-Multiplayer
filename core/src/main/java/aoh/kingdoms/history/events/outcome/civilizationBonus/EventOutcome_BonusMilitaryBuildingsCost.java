...
public class EventOutcome_BonusMilitaryBuildingsCost extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusMilitaryBuildingsCost(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.MilitaryBuildingsCost = this.value / 100.0f;
