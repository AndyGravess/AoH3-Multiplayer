...
public class EventOutcome_BonusIncomeEconomy extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusIncomeEconomy(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.IncomeEconomy = this.value / 100.0f;
