...
public class EventOutcome_BonusConstructionTime extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusConstructionTime(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.ConstructionTime = this.value / 100.0f;
