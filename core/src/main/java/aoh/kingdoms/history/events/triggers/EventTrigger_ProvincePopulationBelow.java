...
public class EventTrigger_ProvincePopulationBelow extends EventTrigger_Value
{
    public int provID;
    public float value;
    
    public EventTrigger_ProvincePopulationBelow(final int provID, final float value) {
        this.provID = provID;
        this.value = value;
    }
