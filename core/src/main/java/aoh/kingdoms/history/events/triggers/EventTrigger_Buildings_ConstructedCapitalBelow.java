...
public class EventTrigger_Buildings_ConstructedCapitalBelow extends EventTrigger_Value
{
    public int value;
    
    public EventTrigger_Buildings_ConstructedCapitalBelow(final int value) {
        this.value = value;
    }
