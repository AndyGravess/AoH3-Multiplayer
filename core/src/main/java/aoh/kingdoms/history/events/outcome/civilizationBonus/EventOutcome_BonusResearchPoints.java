...
public class EventOutcome_BonusResearchPoints extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusResearchPoints(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.ResearchPoints = this.value;
