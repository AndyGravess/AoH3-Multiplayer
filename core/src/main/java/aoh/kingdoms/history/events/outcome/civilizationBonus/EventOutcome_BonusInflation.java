...
public class EventOutcome_BonusInflation extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusInflation(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.Inflation = this.value / 100.0f;
