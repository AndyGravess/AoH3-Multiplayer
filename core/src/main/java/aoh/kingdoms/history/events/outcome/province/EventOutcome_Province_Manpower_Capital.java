...
public class EventOutcome_Province_Manpower_Capital extends EventOutcome
{
    public float value;
    
    public EventOutcome_Province_Manpower_Capital(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            Game.getProvince(Game.getCiv(iCivID).getCapitalProvinceID()).setManpower(Game.getProvince(Game.getCiv(iCivID).getCapitalProvinceID()).getManpower() + this.value);
