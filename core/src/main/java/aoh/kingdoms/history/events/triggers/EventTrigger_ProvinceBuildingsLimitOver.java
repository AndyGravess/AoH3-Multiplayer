...
public class EventTrigger_ProvinceBuildingsLimitOver extends EventTrigger_Value
{
    public int provID;
    public float value;
    
    public EventTrigger_ProvinceBuildingsLimitOver(final int provID, final float value) {
        this.provID = provID;
        this.value = value;
    }
