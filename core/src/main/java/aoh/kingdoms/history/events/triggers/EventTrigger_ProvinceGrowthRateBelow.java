...
public class EventTrigger_ProvinceGrowthRateBelow extends EventTrigger_Value
{
    public int provID;
    public float value;
    
    public EventTrigger_ProvinceGrowthRateBelow(final int provID, final float value) {
        this.provID = provID;
        this.value = value;
    }
