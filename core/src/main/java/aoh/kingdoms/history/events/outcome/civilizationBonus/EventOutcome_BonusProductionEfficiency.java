...
public class EventOutcome_BonusProductionEfficiency extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusProductionEfficiency(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.ProductionEfficiency = this.value;
