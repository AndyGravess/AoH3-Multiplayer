...
public class EventOutcome_BonusMaxMorale extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusMaxMorale(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.MaxMorale = this.value / 100.0f;
