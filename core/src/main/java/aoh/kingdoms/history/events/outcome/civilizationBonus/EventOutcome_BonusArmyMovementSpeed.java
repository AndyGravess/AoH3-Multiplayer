...
public class EventOutcome_BonusArmyMovementSpeed extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusArmyMovementSpeed(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.ArmyMovementSpeed = this.value;
