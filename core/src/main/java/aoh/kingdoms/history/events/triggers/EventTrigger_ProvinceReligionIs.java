...
public class EventTrigger_ProvinceReligionIs extends EventTrigger_Value
{
    public int provID;
    public int value;
    
    public EventTrigger_ProvinceReligionIs(final int provID, final int value) {
        this.provID = provID;
        this.value = value;
    }
    ...
    public String getText() {
        return Game.getProvince(this.provID).getProvinceName() + ", " + Game.lang.get("Religion") + " == ";
    }
