...
public class EventTrigger_Buildings_ConstructedAdministrativeBelow extends EventTrigger_Value
{
    public int value;
    
    public EventTrigger_Buildings_ConstructedAdministrativeBelow(final int value) {
        this.value = value;
    }
