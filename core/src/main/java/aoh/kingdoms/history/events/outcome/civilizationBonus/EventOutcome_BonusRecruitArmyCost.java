...
public class EventOutcome_BonusRecruitArmyCost extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusRecruitArmyCost(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.RecruitArmyCost = this.value;
