...
public class EventOutcome_BonusMaintenanceCost extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusMaintenanceCost(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.MaintenanceCost = this.value;
    ...
    public String getStringLeft() {
        return Game.lang.get("MaintenanceCost") + ": ";
    }
