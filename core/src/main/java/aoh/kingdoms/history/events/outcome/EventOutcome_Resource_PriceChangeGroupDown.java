...
public class EventOutcome_Resource_PriceChangeGroupDown extends EventOutcome
{
    public int iGroupID;
    ...
    public EventOutcome_Resource_PriceChangeGroupDown(final int iGroupID, final int changePrice_Min, final int changePrice_Random, final int timeInMonths_Min, final int timeInMonths_Random) {
