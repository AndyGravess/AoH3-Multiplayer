...
public class EventOutcome_Resource_PriceChangeGroupUp extends EventOutcome
{
    public int iGroupID;
    ...
    public EventOutcome_Resource_PriceChangeGroupUp(final int iGroupID, final int changePrice_Min, final int changePrice_Random, final int timeInMonths_Min, final int timeInMonths_Random) {
        ...
        this.changePrice = changePrice_Min + ((changePrice_Random > 0) ? Game.oR.nextInt(changePrice_Random + 1) : 0);
    ...
    public void update() {
        try {
            this.changePrice = this.changePrice_Min + ((this.changePrice_Random > 0) ? Game.oR.nextInt(this.changePrice_Random + 1) : 0);
