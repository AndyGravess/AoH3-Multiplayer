...
public class EventOutcome_BonusLoansLimit extends EventOutcome
{
    public int value;
    
    public EventOutcome_BonusLoansLimit(final int value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.MaxNumberOfLoans = this.value;
