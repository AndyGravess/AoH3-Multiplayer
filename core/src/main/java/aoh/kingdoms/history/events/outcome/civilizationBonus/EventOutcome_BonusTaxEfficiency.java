...
public class EventOutcome_BonusTaxEfficiency extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusTaxEfficiency(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.TaxEfficiency = this.value;
