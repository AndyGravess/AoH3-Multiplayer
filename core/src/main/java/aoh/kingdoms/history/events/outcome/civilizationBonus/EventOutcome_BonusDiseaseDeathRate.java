...
public class EventOutcome_BonusDiseaseDeathRate extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusDiseaseDeathRate(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.DiseaseDeathRate = this.value / 100.0f;
