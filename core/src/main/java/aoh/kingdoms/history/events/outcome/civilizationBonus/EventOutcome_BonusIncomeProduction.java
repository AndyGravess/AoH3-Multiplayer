...
public class EventOutcome_BonusIncomeProduction extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusIncomeProduction(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.IncomeProduction = this.value;
