...
public class EventOutcome_Province_TaxEfficiency_Capital extends EventOutcome
{
    public float value;
    
    public EventOutcome_Province_TaxEfficiency_Capital(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            Game.getProvince(Game.getCiv(iCivID).getCapitalProvinceID()).setTaxEfficiency(Game.getProvince(Game.getCiv(iCivID).getCapitalProvinceID()).getTaxEfficiency() + this.value);
            Game.getProvince(Game.getCiv(iCivID).getCapitalProvinceID()).updateProvinceIncome();
