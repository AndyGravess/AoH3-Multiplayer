...
public class EventTrigger_CivMilitaryAcademyForGeneralsBelow extends EventTrigger_Value
{
    public int value;
    
    public EventTrigger_CivMilitaryAcademyForGeneralsBelow(final int value) {
        this.value = value;
    }
