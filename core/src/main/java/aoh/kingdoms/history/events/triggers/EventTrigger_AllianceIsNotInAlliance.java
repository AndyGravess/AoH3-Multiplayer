...
public class EventTrigger_AllianceIsNotInAlliance extends EventTrigger_Value
{
    public int value;
    
    public EventTrigger_AllianceIsNotInAlliance(final int value) {
        this.value = value;
    }
    ...
    public String getText() {
        if (this.value < Game.alliancesSpecialSize) {
            return Game.lang.get(Game.alliancesSpecial.get(Game.getCiv(Game.player.iCivID).inAlliance.get(this.value)).Name_Alliance) + ": ";
        }
    ...
    public String getText2() {
        return "" + Game.lang.get("Member") + ", " + Game.lang.get("NOT");
    }
