...
public class EventOutcome_BonusBuildingsMaintenanceCost extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusBuildingsMaintenanceCost(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.BuildingsMaintenanceCost = this.value / 100.0f;
    ...
    public String getStringRight2(final int bonus_duration) {
        return Game.lang.get("YearsX", bonus_duration) + ", " + Game.lang.get("CivilizationBonus");
    }
