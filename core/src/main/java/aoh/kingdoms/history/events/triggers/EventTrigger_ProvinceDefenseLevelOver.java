...
public class EventTrigger_ProvinceDefenseLevelOver extends EventTrigger_Value
{
    public int provID;
    public float value;
    
    public EventTrigger_ProvinceDefenseLevelOver(final int provID, final float value) {
        this.provID = provID;
        this.value = value;
    }
