...
public class EventOutcome_Province_Infrastructure_Capital extends EventOutcome
{
    public int value;
    
    public EventOutcome_Province_Infrastructure_Capital(final int value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            Game.getProvince(Game.getCiv(iCivID).getCapitalProvinceID()).setInfrastructure(Game.getProvince(Game.getCiv(iCivID).getCapitalProvinceID()).getInfrastructure() + this.value);
        }
