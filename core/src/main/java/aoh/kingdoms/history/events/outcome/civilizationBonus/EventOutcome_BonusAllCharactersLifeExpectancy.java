...
public class EventOutcome_BonusAllCharactersLifeExpectancy extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusAllCharactersLifeExpectancy(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.AllCharactersLifeExpectancy = (int)this.value;
    ...
    public String getStringRight() {
        return ((this.value > 0.0f) ? "+" : "") + CFG.getPrecision2(this.value, 1);
    }
