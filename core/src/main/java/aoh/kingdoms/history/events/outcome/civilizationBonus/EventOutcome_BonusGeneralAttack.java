...
public class EventOutcome_BonusGeneralAttack extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusGeneralAttack(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.GeneralAttack = (int)this.value;
