...
public class EventOutcome_BonusCorruption extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusCorruption(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.Corruption = this.value / 100.0f;
    ...
    public String getStringLeft() {
        return Game.lang.get("Corruption") + ": ";
    }
