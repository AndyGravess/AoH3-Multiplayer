...
public class EventOutcome_Province_Economy extends EventOutcome
{
    public float value;
    
    public EventOutcome_Province_Economy(final float value) {
        this.value = value;
    }
    ...
    public void updateProvince(final int iProvinceID) {
        try {
            Game.getProvince(iProvinceID).setEconomy(Game.getProvince(iProvinceID).getEconomy() + this.value);
            Game.getProvince(iProvinceID).updateAfterEconomyChange();
