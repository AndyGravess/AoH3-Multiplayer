...
public class EventOutcome_Province_Devastation_ID extends EventOutcome
{
    public int provID;
    public float value;
    
    public EventOutcome_Province_Devastation_ID(final int provID, final float value) {
        this.provID = provID;
        this.value = value;
    }
    ...
    public void updateProvince(final int iProvinceID) {
        try {
            Game.getProvince(this.provID).setDevastation(Game.getProvince(this.provID).getDevastation() + this.value / 100.0f);
        }
