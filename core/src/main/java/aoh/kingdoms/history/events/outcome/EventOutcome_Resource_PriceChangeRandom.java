...
public class EventOutcome_Resource_PriceChangeRandom extends EventOutcome
{
    ...
    public EventOutcome_Resource_PriceChangeRandom(final int changePrice_Min, final int changePrice_Random, final int timeInMonths_Min, final int timeInMonths_Random) {
