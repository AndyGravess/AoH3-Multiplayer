...
public class EventOutcome_BonusArmyMaintenance extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusArmyMaintenance(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.ArmyMaintenance = this.value;
