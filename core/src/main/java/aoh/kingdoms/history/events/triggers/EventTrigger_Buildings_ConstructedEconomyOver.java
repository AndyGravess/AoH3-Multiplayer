...
public class EventTrigger_Buildings_ConstructedEconomyOver extends EventTrigger_Value
{
    public int value;
    
    public EventTrigger_Buildings_ConstructedEconomyOver(final int value) {
        this.value = value;
    }
