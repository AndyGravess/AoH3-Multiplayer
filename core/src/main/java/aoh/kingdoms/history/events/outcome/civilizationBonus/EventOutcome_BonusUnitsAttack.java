...
public class EventOutcome_BonusUnitsAttack extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusUnitsAttack(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.UnitsAttack = (int)this.value;
