...
public class EventOutcome_BonusIncomeTaxation extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusIncomeTaxation(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.IncomeTaxation = this.value / 100.0f;
