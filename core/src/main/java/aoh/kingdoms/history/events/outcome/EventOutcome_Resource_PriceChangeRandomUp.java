...
public class EventOutcome_Resource_PriceChangeRandomUp extends EventOutcome
{
    ...
    public EventOutcome_Resource_PriceChangeRandomUp(final int changePrice_Min, final int changePrice_Random, final int timeInMonths_Min, final int timeInMonths_Random) {
