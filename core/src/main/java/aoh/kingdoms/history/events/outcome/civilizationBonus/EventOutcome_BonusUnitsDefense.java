...
public class EventOutcome_BonusUnitsDefense extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusUnitsDefense(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.UnitsDefense = (int)this.value;
