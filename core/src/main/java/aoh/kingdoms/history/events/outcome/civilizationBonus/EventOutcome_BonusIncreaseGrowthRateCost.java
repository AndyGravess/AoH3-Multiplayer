...
public class EventOutcome_BonusIncreaseGrowthRateCost extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusIncreaseGrowthRateCost(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.IncreaseGrowthRateCost = this.value / 100.0f;
