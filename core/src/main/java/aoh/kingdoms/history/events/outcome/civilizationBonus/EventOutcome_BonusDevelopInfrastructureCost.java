...
public class EventOutcome_BonusDevelopInfrastructureCost extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusDevelopInfrastructureCost(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.DevelopInfrastructureCost = this.value / 100.0f;
    ...
    @Override
    public int getImage() {
        return Images.infrastructureUp;
    }
}
