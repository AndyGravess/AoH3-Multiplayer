...
public class EventOutcome_BonusBattleWidth extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusBattleWidth(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.BattleWidth = (int)this.value;
