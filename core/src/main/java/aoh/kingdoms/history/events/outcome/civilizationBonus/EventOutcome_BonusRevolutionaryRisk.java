...
public class EventOutcome_BonusRevolutionaryRisk extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusRevolutionaryRisk(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.RevolutionaryRisk = this.value;
    ...
    public String getStringLeft() {
        return Game.lang.get("RevolutionaryRisk") + ": ";
    }
