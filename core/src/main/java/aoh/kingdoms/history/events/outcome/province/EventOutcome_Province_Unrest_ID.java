...
public class EventOutcome_Province_Unrest_ID extends EventOutcome
{
    public int provID;
    public float value;
    
    public EventOutcome_Province_Unrest_ID(final int provID, final float value) {
        this.provID = provID;
        this.value = value;
    }
    ...
    public void updateProvince(final int iProvinceID) {
        try {
            Game.getProvince(this.provID).setRevulutionaryRisk(Game.getProvince(this.provID).getRevulutionaryRisk() + this.value);
        }
