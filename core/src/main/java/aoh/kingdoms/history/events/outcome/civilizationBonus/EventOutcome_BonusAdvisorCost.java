...
public class EventOutcome_BonusAdvisorCost extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusAdvisorCost(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.AdvisorCost = this.value / 100.0f;
