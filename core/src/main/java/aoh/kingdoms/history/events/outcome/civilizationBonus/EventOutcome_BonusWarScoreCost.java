...
public class EventOutcome_BonusWarScoreCost extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusWarScoreCost(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.WarScoreCost = this.value / 100.0f;
