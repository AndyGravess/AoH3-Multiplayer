...
public class EventTrigger_ProvinceBuildingsOver extends EventTrigger_Value
{
    public int provID;
    public float value;
    
    public EventTrigger_ProvinceBuildingsOver(final int provID, final float value) {
        this.provID = provID;
        this.value = value;
    }
