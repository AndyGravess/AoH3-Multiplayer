...
public class EventOutcome_BonusReligionCost extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusReligionCost(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.ReligionCost = this.value;
