...
public class EventOutcome_BonusGeneralCost extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusGeneralCost(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.GeneralCost = this.value / 100.0f;
