...
public class EventTrigger_ProvinceTaxEfficiencyOver extends EventTrigger_Value
{
    public int provID;
    public float value;
    
    public EventTrigger_ProvinceTaxEfficiencyOver(final int provID, final float value) {
        this.provID = provID;
        this.value = value;
    }
