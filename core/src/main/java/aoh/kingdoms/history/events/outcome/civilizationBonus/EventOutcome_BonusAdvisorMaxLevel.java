...
public class EventOutcome_BonusAdvisorMaxLevel extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusAdvisorMaxLevel(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.AdvisorMaxLevel = (int)this.value;
