...
public class EventOutcome_BonusRecruitmentTime extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusRecruitmentTime(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.RecruitmentTime = this.value;
