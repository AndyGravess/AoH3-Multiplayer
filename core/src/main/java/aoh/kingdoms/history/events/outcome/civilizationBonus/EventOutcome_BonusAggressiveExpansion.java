...
public class EventOutcome_BonusAggressiveExpansion extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusAggressiveExpansion(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.AggressiveExpansion = this.value;
