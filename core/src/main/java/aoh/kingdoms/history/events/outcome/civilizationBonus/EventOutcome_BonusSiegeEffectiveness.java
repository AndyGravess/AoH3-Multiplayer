...
public class EventOutcome_BonusSiegeEffectiveness extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusSiegeEffectiveness(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.SiegeEffectiveness = this.value / 100.0f;
