...
public class EventOutcome_Resource_PriceChange extends EventOutcome
{
    ...
    public EventOutcome_Resource_PriceChange(final int iResourceID, final int changePrice_Min, final int changePrice_Random, final int timeInMonths_Min, final int timeInMonths_Random) {
