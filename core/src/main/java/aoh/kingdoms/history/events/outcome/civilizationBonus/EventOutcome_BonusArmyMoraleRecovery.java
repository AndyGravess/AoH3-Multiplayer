...
public class EventOutcome_BonusArmyMoraleRecovery extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusArmyMoraleRecovery(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.ArmyMoraleRecovery = this.value / 100.0f;
