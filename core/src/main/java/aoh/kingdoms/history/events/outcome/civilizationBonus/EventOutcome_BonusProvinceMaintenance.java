...
public class EventOutcome_BonusProvinceMaintenance extends EventOutcome
{
    public float value;
    
    public EventOutcome_BonusProvinceMaintenance(final float value) {
        this.value = value;
    }
    ...
    public void updateCiv(final int iCivID, final int bonus_duration) {
        try {
            ...
            nCivBonus.ProvinceMaintenance = this.value;
