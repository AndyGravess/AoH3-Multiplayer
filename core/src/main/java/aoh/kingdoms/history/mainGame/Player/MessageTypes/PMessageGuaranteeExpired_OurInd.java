...
public class PMessageGuaranteeExpired_OurInd extends PMessage
{
    public PMessageGuaranteeExpired_OurInd(final int iFromCivID, final int iExpiresTurnID) {
    ...
    public void actionClick() {
        ...
        Game.menuManager.rebuildInGame_Info(Game.lang.get("OurIndependenceIsNoLongerGuaranteedBy"), Game.getCiv(this.fromCivID).getCivName());
    ...
    public MenuElement_Hover buildElementHover() {
        ...
        nData.add(new MenuElement_HoverElement_Type_TextTitle_BG(Game.lang.get("OurIndependenceIsNoLongerGuaranteedBy") + ": " + Game.getCiv(this.fromCivID).getCivName(), CFG.FONT_BOLD, Colors.HOVER_GOLD));
    ...
    public int getImageID() {
        return Images.guaranteeIndependenceExpired;
    }
}
