...
public class PMessageAllianceExpired extends PMessage
{
    public PMessageAllianceExpired(final int iFromCivID, final int iExpiresTurnID) {
    ...
    public void actionClick() {
        ...
        Game.menuManager.rebuildInGame_Info(Game.lang.get("AllianceExpired"), Game.getCiv(this.fromCivID).getCivName() + " - " + Game.getCiv(Game.player.iCivID).getCivName());
    ...
    public MenuElement_Hover buildElementHover() {
        ...
        nData.add(new MenuElement_HoverElement_Type_TextTitle_BG(Game.lang.get("AllianceExpired"), CFG.FONT_BOLD, Colors.HOVER_GOLD));
