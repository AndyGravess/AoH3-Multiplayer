...
public class PMessageGuaranteeExpired_We extends PMessage
{
    public PMessageGuaranteeExpired_We(final int iFromCivID, final int iExpiresTurnID) {
    ...
    public void actionClick() {
        ...
        Game.menuManager.rebuildInGame_Info(Game.lang.get("WeNoLongerGuaranteeIndependenceOf"), Game.getCiv(this.fromCivID).getCivName());
    ...
    public MenuElement_Hover buildElementHover() {
        ...
        nData.add(new MenuElement_HoverElement_Type_TextTitle_BG(Game.lang.get("WeNoLongerGuaranteeIndependenceOf") + ": " + Game.getCiv(this.fromCivID).getCivName(), CFG.FONT_BOLD, Colors.HOVER_GOLD));
