...
public class PMessageTruceExpired extends PMessage
{
    public PMessageTruceExpired(final int iFromCivID, final int iExpiresTurnID) {
    ...
    public void actionClick() {
        ...
        Game.menuManager.rebuildInGame_Info(Game.lang.get("TheTruceHasExpiredWith"), Game.getCiv(this.fromCivID).getCivName());
    ...
    public MenuElement_Hover buildElementHover() {
        ...
        nData.add(new MenuElement_HoverElement_Type_TextTitle_BG(Game.lang.get("TheTruceHasExpiredWith") + ": " + Game.getCiv(this.fromCivID).getCivName(), CFG.FONT_BOLD, Colors.HOVER_GOLD));
