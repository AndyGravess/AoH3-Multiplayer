...
public class PMessageNonAggressionPactExpired extends PMessage
{
    public PMessageNonAggressionPactExpired(final int iFromCivID, final int iExpiresTurnID) {
    ...
    public void actionClick() {
        ...
        Game.menuManager.rebuildInGame_Info(Game.lang.get("NonAggressionPactHasExpiredWith"), Game.getCiv(this.fromCivID).getCivName());
    ...
    public MenuElement_Hover buildElementHover() {
        ...
        nData.add(new MenuElement_HoverElement_Type_TextTitle_BG(Game.lang.get("NonAggressionPactHasExpiredWith") + ": " + Game.getCiv(this.fromCivID).getCivName(), CFG.FONT_BOLD, Colors.HOVER_GOLD));
    ...
    public int getImageID() {
        return Images.nonAggressionExpired;
    }
}
