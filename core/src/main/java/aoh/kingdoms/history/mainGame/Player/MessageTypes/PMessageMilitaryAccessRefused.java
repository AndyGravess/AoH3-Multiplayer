...
public class PMessageMilitaryAccessRefused extends PMessage
{
    public PMessageMilitaryAccessRefused(final int iFromCivID, final int iExpiresTurnID) {
    ...
    public void actionClick() {
        ...
        Game.menuManager.rebuildInGame_Info(Game.getCiv(this.fromCivID).getCivName() + ": " + Game.lang.get("DemandMilitaryAccess"), Game.lang.get("Refused"));
    ...
    public MenuElement_Hover buildElementHover() {
        ...
        nData.add(new MenuElement_HoverElement_Type_TextTitle_BG(Game.lang.get("DemandMilitaryAccess") + ": " + Game.lang.get("Refused"), CFG.FONT_BOLD, Colors.HOVER_GOLD));
